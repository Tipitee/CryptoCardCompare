...
const L: Record<string, {
  ...
  pt: {
    title: `Análises de Cartões Crypto ${YEAR}, Testes e Comparativo | TopCryptoCards`,
    desc: `Análises detalhadas e objetivas dos melhores cartões crypto: Crypto.com, Binance, Bybit, OKX, Nexo, Coinbase e mais. Notas, cashback, taxas e veredictos.`,
    badge: `Análises e Testes ${YEAR}`, h1: `Análises de Cartões Crypto ${YEAR}`,
    sub: 'Testes completos e objetivos dos melhores cartões crypto do mercado. Cashback, taxas, segurança e experiência de utilizador ao pormenor.',
    topPick: 'A nossa melhor escolha', readReview: 'Ler a análise',
    cashback: 'Cashback máx.', staking: 'Staking obrigatório', fees: 'Taxas anuais',
    stakingNo: '✅ Nenhum', stakingYes: '⚠️ Sim',
    updatedAt: 'Atualizado',
    ctaH2: 'Não sabes que cartão escolher?',
    ctaSub: 'O nosso comparador analisa o teu perfil e os teus gastos para te recomendar o cartão mais rentável.',
    compare: 'Comparar todos os cartões', recommend: 'Encontrar o meu cartão ideal',
    breadcrumb: 'Análises de cartões crypto', brandPage: 'Página da marca →', home: 'Início',
  },
  de: {
  ...
  it: {
    ...
    desc: `Recensioni dettagliate e obiettive sulle migliori carte crypto disponibili in Italia: Crypto.com, Bybit, OKX, Nexo, Gnosis Pay, MetaMask Card, Young Platform e altro.`,
...
const REVIEW_EDITORIAL: Record<string, string> = {
  ...
  it: `Scegliere una carta crypto nel 2026 richiede ben più di un confronto tra le percentuali di cashback pubblicizzate. Le condizioni reali, staking obbligatorio, limiti mensili, disponibilità in Italia, registrazione OAM/MiCA, rete Visa o Mastercard, sono quelle che determinano se una carta è davvero redditizia o semplice marketing. Le nostre recensioni vengono redatte dopo un'analisi approfondita di ogni prodotto: consultiamo i termini e le condizioni, i forum utenti, le esperienze reali e i dati ufficiali pubblicati dagli emittenti. Ogni carta riceve un voto globale su 5 calcolato su cinque dimensioni: cashback, commissioni, accessibilità, sicurezza normativa ed esperienza utente. Le nostre recensioni coprono i principali attori disponibili in Italia, Crypto.com, Bybit, OKX, Nexo, Young Platform, ma anche alternative spesso sottovalutate: Gnosis Pay (cashback in EURE, vera self-custody), MetaMask Card (1% in ETH, senza staking) e Brighty (fino al 4% senza staking).`,
  ...
  pt: `Escolher um cartão crypto em 2026 exige muito mais do que olhar para a taxa de cashback anunciada. As condições reais, staking obrigatório, limites mensais, disponibilidade em Portugal, registo junto do Banco de Portugal ou MiCA, rede Visa ou Mastercard, é que determinam se um cartão é realmente rentável ou apenas uma promessa de marketing. As nossas análises são redigidas após uma análise aprofundada de cada produto: consultamos as condições gerais, os fóruns de utilizadores, os relatos de experiência reais e os dados oficiais publicados pelos emissores. Cada cartão recebe uma nota global sobre 5 calculada a partir de cinco dimensões: cashback, comissões, acessibilidade, segurança regulatória e experiência de utilização. As nossas análises cobrem os principais atores, Crypto.com, Binance, Bybit, OKX, Nexo, mas também alternativas menos conhecidas que merecem atenção: Gnosis Pay, MetaMask Card, Brighty, Trade Republic. Lembra-te ainda da fiscalidade portuguesa: pagar com cripto detida há menos de 365 dias gera uma mais-valia tributada a 28%, isenta a partir de um ano.`,
};
...
const REVIEW_RELATED: {
  ...
  themes: [
    { key: 'best',       emoji: '⭐', label: { fr: 'Meilleures cartes',     de: 'Beste Karten',         es: 'Mejores tarjetas',    it: 'Migliori carte',      en: 'Best cards',      pt: 'Melhores cartões' } },
    { key: 'cashback',   emoji: '💰', label: { fr: 'Cashback élevé',         de: 'Hoher Cashback',       es: 'Alto cashback',       it: 'Alto cashback',       en: 'High cashback',   pt: 'Cashback elevado' } },
    { key: 'no-fees',    emoji: '🆓', label: { fr: 'Sans frais annuels',     de: 'Ohne Jahresgebühr',    es: 'Sin comisiones',      it: 'Senza costi annuali', en: 'No annual fees',  pt: 'Sem taxas anuais' } },
    { key: 'no-staking', emoji: '🔓', label: { fr: 'Sans staking',           de: 'Ohne Staking',         es: 'Sin staking',         it: 'Senza staking',       en: 'No staking',      pt: 'Sem staking' } },
    { key: 'travel',     emoji: '✈️', label: { fr: 'Cartes voyage',          de: 'Reisekarten',          es: 'Tarjetas de viaje',   it: 'Carte viaggio',       en: 'Travel cards',    pt: 'Cartões de viagem' } },
    { key: 'beginner',   emoji: '🌱', label: { fr: 'Pour débutants',         de: 'Für Einsteiger',       es: 'Para principiantes',  it: 'Per principianti',    en: 'For beginners',   pt: 'Para iniciantes' } },
  ],
};
