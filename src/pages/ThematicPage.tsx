...
const THEME_CONFIG: Record<string, Record<string, {
  ...
  beginner: {
    ...
    de: { title:`Krypto Karte Einsteiger ${YEAR} — Einfach, Ohne Risiko | TopCryptoCards`, h1:`Beste Krypto-Karten für Einsteiger`, description:`Beste Einstiegskarten für Krypto-Anfänger ${YEAR}: kein Staking, keine Gebühren, sofortiges Cashback. MetaMask Card, Gnosis Pay, Brighty — einfach & sicher. Kostenlos ✓`, intro:`Diese Karten wurden für ihre Einfachheit ausgewählt: kein Staking erforderlich, keine Jahresgebühr, sofortiges Cashback ab dem ersten Kauf.`, outro:`Für Einsteiger ist Benutzerfreundlichkeit das wichtigste Kriterium. Beginnen Sie mit einer Karte ohne Staking und ohne Gebühren.` },
    es: { title:`Tarjeta Crypto Principiante ${YEAR} — Simple y Sin Riesgo | TopCryptoCards`, h1:`Mejores Tarjetas Crypto para Principiantes`, description:`Mejores tarjetas crypto para principiantes ${YEAR}: sin staking, sin cuota, cashback inmediato. MetaMask Card, Gnosis Pay, Brighty — simples y seguras. Gratis ✓`, intro:`Estas tarjetas han sido seleccionadas por su simplicidad: sin staking requerido, sin cuota anual, cashback inmediato desde la primera compra.`, outro:`Para un principiante, el criterio más importante es la facilidad de uso. Empieza con una tarjeta sin staking y sin comisiones.` },
