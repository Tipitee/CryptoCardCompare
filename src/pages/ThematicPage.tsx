...
const THEME_CONFIG: Record<string, Record<string, {
  ...
  france: {
    ...
    it: { title:`Carta Crypto Italia ${YEAR} — Confronto | TopCryptoCards`, h1:`Carte Crypto Disponibili in Italia`, description:`Le migliori carte crypto disponibili in Italia nel ${YEAR}: fino all'8% cashback, senza costi. Regolamentazione OAM verificata. Crypto.com, Gnosis Pay, MetaMask Card. Gratuito ✓`, intro:`Non tutte le carte crypto sono disponibili in Italia. Questo confronto elenca solo quelle accessibili ai residenti italiani nel ${YEAR}.`, outro:`In Italia, preferisci carte emesse da entità registrate presso l'OAM (Organismo Agenti e Mediatori). Questo garantisce un livello minimo di protezione dei tuoi fondi.` },
  ...
  virtual: {
    ...
    it: { title:`Carta Crypto Virtuale ${YEAR} — Pagamenti | TopCryptoCards`, h1:`Carte Crypto Virtuali nel ${YEAR}`, description:`Le migliori carte crypto virtuali per pagamenti online nel ${YEAR}: attivate immediatamente, compatibili Apple Pay e Google Pay. MetaMask Card, Gnosis Pay, Brighty. Gratuito ✓`, intro:`Le carte crypto virtuali sono ideali per gli acquisti online e i pagamenti contactless. Spesso sono disponibili immediatamente dopo la registrazione.`, outro:`La carta virtuale è spesso il modo più rapido per iniziare a spendere crypto. Disponibile in pochi minuti dopo la validazione KYC, si collega direttamente ad Apple Pay o Google Pay.` },
  ...
  beginner: {
    ...
    es: { title:`Tarjeta Crypto Principiante ${YEAR} — Guía | TopCryptoCards`, h1:`Mejores Tarjetas Crypto para Principiantes`, description:`Mejores tarjetas crypto para principiantes ${YEAR}: sin staking, sin cuota, cashback inmediato. MetaMask Card, Gnosis Pay, Brighty — simples y seguras. Gratis ✓`, intro:`Estas tarjetas han sido seleccionadas por su simplicidad: sin staking requerido, sin cuota anual, cashback inmediato desde la primera compra.`, outro:`Para un principiante, el criterio más importante es la facilidad de uso. Empieza con una tarjeta sin staking y sin comisiones.` },
  ...
  travel: {
    fr: { title:`Carte Crypto Voyage ${YEAR} — Sans Frais | TopCryptoCards`, h1:`Meilleures Cartes Crypto pour Voyager en ${YEAR}`, description:`Quelle carte crypto pour voyager en ${YEAR} ? Sans frais de change, cashback à l'étranger, acceptée dans 200+ pays. Crypto.com, Bybit, Nexo comparés. Gratuit ✓`, intro:`Voyager avec une carte crypto offre de nombreux avantages : pas de frais de change excessifs, cashback en crypto sur chaque achat à l'étranger, et acceptation dans plus de 50 millions de points de vente Visa/Mastercard. Ces cartes sont idéales pour les digital nomads et les voyageurs fréquents qui souhaitent maximiser leurs dépenses à l'international.`, outro:`Pour voyager, privilégiez une carte sans frais de change et avec des plafonds de retrait généreux. La Crypto.com Obsidian offre même les lounges d'aéroport gratuitement. Pour les voyageurs occasionnels, Gnosis Pay ou MetaMask Card suffisent sans aucun frais annuel.` },
    de: { title:`Krypto Karte Reise ${YEAR} — Ohne Gebühren | TopCryptoCards`, h1:`Beste Krypto-Karten für Reisende ${YEAR}`, description:`Beste Krypto-Karte für Reisen ${YEAR}: keine Wechselgebühren, bis zu 5% Cashback im Ausland, in 200+ Ländern akzeptiert. Crypto.com, Bybit, Nexo verglichen. Kostenlos ✓`, intro:`Mit einer Krypto-Karte zu reisen bietet viele Vorteile: keine übermäßigen Wechselgebühren, Cashback in Krypto bei jedem Auslandskauf und Akzeptanz bei über 50 Millionen Händlern weltweit. Diese Karten sind ideal für digitale Nomaden und Vielreisende, die ihre internationalen Ausgaben maximieren möchten.`, outro:`Für Reisen wählen Sie eine Karte ohne Wechselgebühren und mit großzügigen Abhebungslimits. Die Crypto.com Obsidian bietet sogar kostenlose Flughafen-Lounges. Für Gelegenheitsreisende reichen Gnosis Pay oder MetaMask Card ohne Jahresgebühr vollkommen aus.` },
    ...
    it: { title:`Carta Crypto Viaggio ${YEAR} — Senza Costi | TopCryptoCards`, h1:`Migliori Carte Crypto per Viaggiatori nel ${YEAR}`, description:`Migliore carta crypto per viaggiare nel ${YEAR}: senza commissioni di cambio, fino al 5% cashback all'estero, accettata in 200+ paesi. Crypto.com, Bybit, Nexo. Gratuito ✓`, intro:`Viaggiare con una carta crypto offre molti vantaggi: nessuna commissione di cambio eccessiva, cashback in crypto per ogni acquisto all'estero e accettazione in oltre 50 milioni di punti vendita Visa/Mastercard. Queste carte sono ideali per i nomadi digitali e i viaggiatori frequenti che desiderano massimizzare le spese internazionali.`, outro:`Per viaggiare, scegli una carta senza commissioni di cambio e con limiti di prelievo generosi. Crypto.com Obsidian offre persino l'accesso gratuito alle lounge aeroportuali. Per i viaggiatori occasionali, Gnosis Pay o MetaMask Card sono più che sufficienti senza costi annuali.` },
