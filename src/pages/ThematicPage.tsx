...
const THEME_CONFIG: Record<string, Record<string, {
  ...
  best: {
    fr: { title:`Meilleure Carte Crypto ${YEAR}, Top 5 Testées | TopCryptoCards`, h1:`Les Meilleures Cartes Crypto en ${YEAR}`, description:`Quelle est la meilleure carte crypto en ${YEAR} ? Cashback jusqu'à 8%, 0€/an, sans staking. Crypto.com, Nexo, Gnosis Pay, MetaMask comparées. Verdict indépendant ✓`, intro:`La meilleure carte crypto en ${YEAR} sans staking est la Nexo Card : 2% de cashback en BTC, 0€/an, disponible en France. Pour maximiser le cashback avec staking, Crypto.com Jade offre 3% avec 50 000 CRO immobilisés (~18 000€). Ce comparatif indépendant classe les cartes disponibles en France par profil d'usage, avec les frais et taux vérifiés en juillet ${YEAR}.`, outro:`Pour faire le bon choix, comparez les taux de cashback mais pensez aussi aux conditions : certaines cartes exigent un staking important pour débloquer les meilleurs avantages. Si vous débutez, préférez une carte sans staking et sans frais annuels. Si vous êtes déjà investi en crypto, les cartes premium peuvent offrir jusqu'à 8% de cashback.` },
    ...
    it: { title:`Migliore Carta Crypto ${YEAR}, Top 5 Testate | TopCryptoCards`, h1:`Le Migliori Carte Crypto nel ${YEAR}`, description:`Qual è la migliore carta crypto nel ${YEAR}? Cashback fino all'8%, 0€/anno, senza staking. Crypto.com, Nexo, Gnosis Pay, MetaMask comparate. Verdetto indipendente ✓`, intro:`Una carta crypto è una Visa o Mastercard collegata a un portafoglio digitale, che permette di spendere criptovalute nella vita quotidiana e ricevere premi in crypto su ogni acquisto. Cashback, costi annuali, staking richiesto, disponibilità in Italia, regolamentazione: i criteri sono numerosi. Questo confronto raccoglie tutte le carte crypto disponibili nel ${YEAR}, classificate per affidabilità.`, outro:`Per fare la scelta giusta, confronta i tassi di cashback ma considera anche le condizioni: alcune carte richiedono uno staking importante per sbloccare i migliori vantaggi. Se sei un principiante, preferisci una carta senza staking e senza costi annuali.` },
    en: { title:`Best Crypto Card ${YEAR}, Top 5 Tested | TopCryptoCards`, h1:`The Best Crypto Cards in ${YEAR}`, description:`What's the best crypto card in ${YEAR}? Up to 8% cashback, £0/year, no staking. Bitcoin card, Crypto.com, Nexo, Gnosis Pay compared. Independent ✓`, intro:`A crypto card is a Visa or Mastercard linked to a digital wallet, enabling you to spend cryptocurrency in everyday life and earn crypto rewards on every purchase. Cashback rates, annual fees, staking requirements, availability, and regulation all vary significantly. This comparison covers all crypto cards available in ${YEAR}, ranked by reliability and value.`, outro:`To make the right choice, compare cashback rates but also consider the conditions: some cards require significant staking to unlock the best benefits. If you're a beginner, opt for a card with no staking and no annual fee.` },
    be: { title:`Meilleure Carte Crypto Belgique ${YEAR}, Top 5 | TopCryptoCards`, h1:`Les Meilleures Cartes Crypto en Belgique en ${YEAR}`, description:`Quelle est la meilleure carte crypto en Belgique en ${YEAR} ? FSMA/MiCA vérifiée, jusqu'à 8% cashback, 0€/an, sans staking. Crypto.com, Nexo, Gnosis Pay comparées. Gratuit ✓`, intro:`Une carte crypto disponible en Belgique est une carte Visa ou Mastercard émise par un acteur régulé (FSMA ou conforme MiCA), utilisable par les résidents belges pour dépenser leurs cryptomonnaies au quotidien. En tant que siège de l'Union Européenne, la Belgique a accès aux mêmes cartes MiCA qu'en France. Ce comparatif rassemble toutes les cartes crypto disponibles en Belgique en ${YEAR}, classées par fiabilité.`, outro:`En Belgique, choisissez des cartes émises par des entités conformes MiCA ou supervisées par la FSMA. Pour la plupart des résidents belges, Nexo Card (2% en BTC) et Gnosis Pay (2% en GNO) offrent le meilleur rapport cashback/risque sans staking obligatoire.` },
    at: { title:`Beste Krypto-Karte Österreich ${YEAR}, Top 5 | TopCryptoCards`, h1:`Die besten Krypto-Karten in Österreich ${YEAR}`, description:`Welche Krypto-Karte ist die beste in Österreich ${YEAR}? FMA/MiCA-geprüft, bis zu 8% Cashback, 0€/Jahr, kein Staking. Bitpanda, Crypto.com, Nexo, Gnosis Pay verglichen. Kostenlos ✓`, intro:`Eine in Österreich verfügbare Krypto-Karte ist eine Visa- oder Mastercard eines FMA-regulierten oder MiCA-konformen Anbieters, mit der österreichische Einwohner Kryptowährungen im Alltag ausgeben können. Österreich ist die Heimat von Bitpanda, der bestlizenzierten Krypto-Plattform Europas mit Sitz in Wien. Dieser Vergleich listet alle in Österreich verfügbaren Krypto-Karten für ${YEAR}.`, outro:`In Österreich bevorzugen Sie Karten von FMA-regulierten Anbietern. Bitpanda ist die bekannteste österreichische Plattform, mit eigener Karte und 2% Cashback in BEST. Für BTC-Cashback ohne Staking ist Nexo Card auch für österreichische Nutzer die stärkste Option.` },
  },
  cashback: {
    fr: { title:`Carte Crypto Cashback ${YEAR}, Jusqu'à 8% en BTC | TopCryptoCards`, h1:`Cartes Crypto avec le Meilleur Cashback`, description:`Quelle carte crypto rapporte le plus de cashback en ${YEAR} ? Jusqu'à 8% en BTC ou ETH. Crypto.com (8%), Nexo (2% BTC), Gnosis Pay (2% GNO) comparés. Indépendant ✓`, intro:`Le cashback est l'avantage principal des cartes crypto : chaque achat vous rapporte des cryptomonnaies. Mais les taux varient considérablement, de 0.5% à 8% selon les cartes et les conditions. Ce classement compare les cartes crypto avec le meilleur cashback disponibles en ${YEAR}.`, outro:`Attention aux conditions : un taux de 8% peut nécessiter de bloquer 400 000 CRO en staking. Calculez le retour sur investissement réel avant de vous engager. Pour la plupart des utilisateurs, un cashback de 1 à 3% sans staking est plus rentable à long terme.` },
    de: { title:`Krypto Karte Cashback ${YEAR}, Bis 8% in BTC | TopCryptoCards`, h1:`Krypto-Karten mit dem besten Cashback`, description:`Welche Krypto-Karte zahlt mehr Cashback ${YEAR}? Bis zu 8% in BTC oder ETH. Crypto.com (8%), Nexo (2% BTC), Gnosis Pay (2% GNO) verglichen. Unabhängig ✓`, intro:`Cashback ist der Hauptvorteil von Krypto-Karten: Jeder Kauf bringt Ihnen Kryptowährungen ein. Die Sätze variieren jedoch erheblich, von 0,5% bis 8%. Dieses Ranking vergleicht Krypto-Karten mit dem besten Cashback in ${YEAR}.`, outro:`Achten Sie auf die Bedingungen: Ein Satz von 8% kann erhebliches Staking erfordern. Berechnen Sie den tatsächlichen ROI, bevor Sie sich verpflichten. Für die meisten Nutzer ist ein Cashback von 1-3% ohne Staking langfristig rentabler.` },
    ...
    be: { title:`Carte Crypto Cashback Belgique ${YEAR}, Jusqu'à 8% | TopCryptoCards`, h1:`Cartes Crypto Cashback en Belgique en ${YEAR}`, description:`Quelle carte crypto rapporte le plus de cashback en Belgique en ${YEAR} ? Jusqu'à 8% en BTC ou ETH. Crypto.com (8%), Nexo (2% BTC), Gnosis Pay (2% GNO) comparés. FSMA/MiCA ✓`, intro:`Le cashback est l'avantage principal des cartes crypto : chaque achat vous rapporte des cryptomonnaies. En Belgique, les cartes MiCA européennes sont toutes accessibles avec les mêmes taux qu'en France. Ce classement compare les cartes crypto avec le meilleur cashback disponibles pour les résidents belges en ${YEAR}.`, outro:`Attention aux conditions : un taux de 8% peut nécessiter de bloquer des milliers d'euros en staking. Pour les résidents belges sans staking, Nexo Card (2% en BTC) et Gnosis Pay (2% en GNO) offrent le meilleur cashback sans immobilisation de capital.` },
    at: { title:`Krypto Karte Cashback Österreich ${YEAR}, Bis 8% | TopCryptoCards`, h1:`Krypto-Karten mit Cashback in Österreich ${YEAR}`, description:`Welche Krypto-Karte zahlt mehr Cashback in Österreich ${YEAR}? Bis zu 8% in BTC oder ETH. Bitpanda (2% BEST), Nexo (2% BTC), Crypto.com (8% CRO) verglichen. FMA/MiCA ✓`, intro:`Cashback ist der Hauptvorteil von Krypto-Karten: Jeder Kauf bringt Ihnen Kryptowährungen ein. In Österreich sind dieselben MiCA-konformen Karten wie in Deutschland verfügbar, plus Bitpanda, die einheimische Plattform mit 2% Cashback in BEST-Token. Dieses Ranking vergleicht Krypto-Karten mit dem besten Cashback für österreichische Einwohner in ${YEAR}.`, outro:`Für österreichische Nutzer ohne Staking-Präferenz: Nexo Card (2% in BTC), Gnosis Pay (2% in GNO) und Bitpanda Card (2% in BEST) bieten die besten Konditionen. Bitpanda ist dabei die österreichische Hausmarke, mit FMA-Regulierung und Sitz in Wien.` },
  },
  'no-fees': {
    fr: { title:`Carte Crypto Sans Frais ${YEAR}, 0€/an + Cashback | TopCryptoCards`, h1:`Cartes Crypto Sans Frais Annuels en ${YEAR}`, description:`Top 5 cartes crypto gratuites en ${YEAR} : Gnosis Pay (5% cashback), MetaMask Card, Brighty. Aucun abonnement, aucun staking requis. Comparatif indépendant ✓`, intro:`Une carte crypto sans frais annuels est une carte Visa ou Mastercard à 0€/an offrant du cashback en cryptomonnaies sans abonnement ni staking obligatoire. Pourquoi payer un abonnement annuel pour une carte crypto quand des alternatives gratuites offrent d'excellents taux de cashback ? Ce comparatif liste toutes les cartes crypto sans frais annuels disponibles en ${YEAR}, classées par cashback décroissant.`, outro:`Une carte gratuite n'est pas synonyme de carte moins bonne. MetaMask Card, Gnosis Pay ou Brighty offrent de vrais avantages sans aucun abonnement. Comparez les plafonds de retrait et les cryptos acceptées pour choisir la meilleure option gratuite.` },
  ...
  iban: {
    fr: { title:`Carte Crypto avec IBAN ${YEAR}, SEPA + Cashback | TopCryptoCards`, h1:`Cartes Crypto avec IBAN en ${YEAR}`, description:`Quelle carte crypto inclut un IBAN en ${YEAR} ? Deblock (IBAN FR), Brighty (IBAN EU), Revolut. Virements SEPA gratuits, cashback en crypto. Comparatif indépendant ✓`, intro:`Une carte crypto avec IBAN est une Visa ou Mastercard intégrée à un compte avec numéro IBAN européen, permettant de recevoir son salaire, d'effectuer des virements SEPA et de payer en crypto, tout dans une seule application. Ce comparatif liste toutes les cartes crypto offrant un IBAN réel en ${YEAR}.`, outro:`Deblock est la seule néobanque crypto avec un IBAN français et une régulation ACPR complète. Brighty propose un IBAN européen depuis Genève. Revolut et N26 offrent un IBAN avec support des cryptos. Comparez selon votre besoin : IBAN local, régulation, cashback.` },
    de: { title:`Krypto Karte mit IBAN ${YEAR}, SEPA-Überweisungen | TopCryptoCards`, h1:`Krypto-Karten mit IBAN ${YEAR}`, description:`Welche Krypto-Karte hat eine IBAN ${YEAR}? Brighty (EU-IBAN), Revolut, Deblock. Kostenlose SEPA-Überweisungen, Cashback in Krypto. Unabhängiger Vergleich ✓`, intro:`Eine Krypto-Karte mit IBAN ist eine Visa- oder Mastercard, die in ein Konto mit europäischer IBAN-Nummer integriert ist, Gehalt empfangen, SEPA-Überweisungen durchführen und in Krypto bezahlen, alles in einer App. Dieser Vergleich listet alle Krypto-Karten mit echter IBAN in ${YEAR}.`, outro:`Brighty bietet eine europäische IBAN aus der Schweiz. Revolut und N26 bieten IBAN mit Krypto-Support. Für deutsche Nutzer: Bitpanda ist die einheimische Alternative mit Bankfunktionen. Vergleichen Sie nach lokalem IBAN, Regulierung und Cashback-Satz.` },
    es: { title:`Tarjeta Crypto con IBAN ${YEAR}, SEPA + Cashback | TopCryptoCards`, h1:`Tarjetas Crypto con IBAN en ${YEAR}`, description:`¿Qué tarjeta crypto incluye un IBAN en ${YEAR}? Brighty (IBAN EU), Revolut, Deblock. Transferencias SEPA gratuitas, cashback en cripto. Comparativa independiente ✓`, intro:`Una tarjeta crypto con IBAN es una Visa o Mastercard integrada en una cuenta con número IBAN europeo, que te permite recibir tu nómina, hacer transferencias SEPA y pagar en cripto, todo en una sola app. Esta comparativa lista las tarjetas crypto con IBAN real disponibles en ${YEAR}.`, outro:`Brighty ofrece un IBAN europeo desde Suiza. Revolut y N26 ofrecen IBAN con soporte cripto. Deblock es la opción francesa con IBAN local y regulación ACPR. Compara según tu necesidad: IBAN local, regulación, cashback.` },
    it: { title:`Carta Crypto con IBAN ${YEAR}, SEPA + Cashback | TopCryptoCards`, h1:`Carte Crypto con IBAN nel ${YEAR}`, description:`Quale carta crypto include un IBAN nel ${YEAR}? Brighty (IBAN EU), Revolut, Deblock. Bonifici SEPA gratuiti, cashback in crypto. Confronto indipendente ✓`, intro:`Una carta crypto con IBAN è una Visa o Mastercard integrata in un conto con numero IBAN europeo, che ti permette di ricevere stipendio, fare bonifici SEPA e pagare in crypto, tutto in un'unica app. Questo confronto elenca le carte crypto con IBAN reale disponibili nel ${YEAR}.`, outro:`Brighty offre un IBAN europeo dalla Svizzera. Revolut e N26 offrono IBAN con supporto crypto. Deblock è l'opzione francese con IBAN locale e regolamentazione ACPR. Confronta in base alle tue esigenze: IBAN locale, regolamentazione, cashback.` },
...
const THEME_SECTIONS: Partial<Record<string, Partial<Record<string, { h2: string; p: string }[]>>>> = {
  best: {
    ...
    de: [
      ...
      { h2: `Bitcoin Karte Deutschland ${YEAR}: mit BTC und Kryptowährungen im Alltag bezahlen`, p: `Der Begriff "Bitcoin Karte" oder "Kryptowährung Karte" beschreibt drei Produkttypen: (1) Karten, die Ihr BTC oder ETH am Point of Sale in Euro umwandeln, Nexo, Crypto.com, Bybit; (2) Karten mit Bitcoin-Cashback auf jeden Einkauf, Nexo Card gibt zwischen 1% und 2% in BTC zurück, Crypto.com bis zu 8% in CRO; (3) On-Chain-Karten, die direkt Ihr Wallet nutzen, Gnosis Pay und MetaMask Card. Für die meisten deutschen Nutzer bietet die Nexo Card das beste Gleichgewicht: BTC-Cashback, kein Pflicht-Staking, in Deutschland verfügbar und nach MiCA in der EU reguliert. Wer die direkte Verwahrung bevorzugt, findet in Gnosis Pay die fortschrittlichste Bitcoin Karte für Deutschland im ${YEAR}.` },
    ],
    es: [
      ...
      { h2: `Mejores tarjetas bitcoin España ${YEAR}: pagar con BTC en el día a día`, p: `El término "tarjeta bitcoin" o "tarjeta criptomonedas" describe en realidad tres tipos de producto distintos: (1) tarjetas que convierten tu BTC o ETH en euros en el momento del pago, Nexo, Crypto.com, Bybit; (2) tarjetas con cashback en bitcoin sobre cada compra, Nexo Card devuelve entre el 1% y el 2% en BTC, Crypto.com hasta el 8% en CRO; (3) tarjetas on-chain que usan tu wallet directamente, Gnosis Pay y MetaMask Card. Para la mayoría de los españoles, la Nexo Card ofrece el mejor equilibrio: cashback en BTC, sin staking obligatorio, disponible en España y regulada en la UE bajo MiCA.` },
    ...
    it: [
      ...
      { h2: `Carta bitcoin Italia ${YEAR}: pagare con BTC e criptovalute nella vita quotidiana`, p: `Il termine "carta bitcoin" o "carta criptovaluta" descrive tre tipi di prodotto: (1) carte che convertono il tuo BTC o ETH in euro al momento del pagamento, Nexo, Crypto.com, Bybit; (2) carte con cashback in bitcoin su ogni acquisto, Nexo Card restituisce tra l'1% e il 2% in BTC, Crypto.com fino all'8% in CRO; (3) carte on-chain che usano direttamente il tuo wallet, Gnosis Pay e MetaMask Card. Per la maggior parte degli italiani, la Nexo Card offre il miglior equilibrio: cashback in BTC, senza staking obbligatorio, disponibile in Italia e regolamentata nell'UE sotto MiCA. Se preferisci mantenere la custodia diretta delle tue criptovalute, Gnosis Pay è la carta bitcoin più avanzata disponibile in Italia nel ${YEAR}.` },
    ],
    en: [
      ...
      { h2: `Bitcoin card UK ${YEAR}: spending BTC and cryptocurrency in everyday life`, p: `The term "bitcoin card" or "cryptocurrency card" covers three product types: (1) cards that convert your BTC or ETH to pounds at the point of sale, Nexo, Crypto.com, Bybit; (2) cards with bitcoin cashback on every purchase, Nexo Card returns 1% to 2% in BTC, Crypto.com up to 8% in CRO; (3) on-chain cards that work directly from your wallet, Gnosis Pay and MetaMask Card. For most UK users, Nexo Card offers the best balance: BTC cashback, no mandatory staking, available in the UK and regulated under MiCA. If you prefer self-custody, Gnosis Pay is the most advanced bitcoin card available in the UK in ${YEAR}.` },
    ],
  },
  cashback: {
    fr: [
      ...
      { h2: `Fiscalité du cashback crypto en France : ce que dit l'administration`, p: `En France, le cashback reçu en cryptomonnaie est considéré comme un revenu imposable dès réception. Si votre carte verse 50€ de cashback en ETH en janvier, ces 50€ s'ajoutent à vos revenus imposables de l'année, même si vous ne vendez pas l'ETH. Lors de la revente ultérieure, la plus-value est calculée sur la valeur au moment du cashback (prix d'acquisition). Le régime fiscal applicable est la flat tax de 30% (PFU) sur les cessions de crypto-actifs supérieures à 305€/an au total. Bonne nouvelle : les petits montants (quelques euros/mois de cashback en crypto) restent souvent en dessous du seuil de déclaration obligatoire si vous ne revendez pas. Consultez un comptable pour votre situation personnelle et conservez un historique précis des prix d'acquisition de votre cashback.` },
    ],
    de: [
  ...
  travel: {
    ...
    de: [
      ...
      { h2: `Krypto-Karte vs. klassische Reise-Kreditkarte: Der direkte Vergleich`, p: `Viele Deutsche reisen mit traditionellen Reisekreditkarten wie der DKB Visa (0% Auslandsgebühren), N26 Metal oder Barclays Visa. Was bieten Krypto-Karten mehr? Erstens: Cashback in werthaltiger Kryptowährung statt Miles oder Punkten ohne Marktwert. Zweitens: On-Chain-Transparenz, jede Transaktion ist nachvollziehbar. Drittens: Zugang zu DeFi-Renditen, die klassische Karten nicht bieten können. Der Nachteil: Krypto-Karten setzen voraus, dass Sie bereits Kryptowährungen halten oder kaufen. Wenn Sie keine Kryptos besitzen, sind DKB oder N26 weiterhin die einfachste Lösung. Für Krypto-Nutzer ist die Kombination von 0% Wechselgebühren + Krypto-Cashback (Crypto.com, Bybit) jedoch klar attraktiver als ein klassisches Meilenprogramm ohne Kurspotenzial.` },
    ],
    es: [
      ...
      { h2: `Tarjeta crypto para viajar a Latinoamérica: ventajas específicas`, p: `Los españoles que viajan frecuentemente a México, Argentina, Colombia o Perú se enfrentan a tipos de cambio volátiles y comisiones bancarias elevadas. Las tarjetas crypto ofrecen aquí una ventaja clave: conversión al tipo de cambio interbancario en tiempo real, sin margen bancario (generalmente entre 2 y 4% con las tarjetas tradicionales). En destinos con inflación alta como Argentina, cargar la tarjeta en USDC y pagar en peso local protege tu poder adquisitivo. Crypto.com y Bybit son aceptadas en millones de comercios en toda Latinoamérica a través de la red Visa/Mastercard. Para retiradas de efectivo, comprueba el límite mensual gratuito de tu carta, en zonas donde el efectivo sigue siendo necesario, esto marca la diferencia.` },
    ],
    it: [
      ...
      { h2: `Carta crypto per gli italiani all'estero e gli expat`, p: `Per gli italiani che vivono o lavorano all'estero, in particolare in UK, Germania, Svizzera, Australia o Canada, la carta crypto risolve un problema concreto: ricevere o trasferire fondi in euro senza le commissioni bancarie internazionali (che possono arrivare al 3-5%). Gnosis Pay e Brighty permettono di ricevere il proprio stipendio direttamente su un IBAN europeo e di spendere o inviare fondi in tutto il mondo. MetaMask Card funziona direttamente dal proprio wallet, senza dipendere da una banca italiana. Per gli italiani in UK, le carte Visa/Mastercard crypto sono accettate ovunque e non richiedono un conto corrente britannico. Crypto.com e Bybit, disponibili sia in Italia che in UK, permettono di gestire i propri asset crypto da un unico account indipendentemente dal paese di residenza.` },
    ],
    en: [
  ...
  france: {
    ...
    es: [
      ...
      { h2: `Tarjeta bitcoin España ${YEAR}: pagar con BTC y criptomonedas en el día a día`, p: `Una tarjeta bitcoin en España te permite convertir tu BTC, ETH o USDC en compras cotidianas, supermercados, gasolineras, Amazon, restaurantes, sin vender previamente en un exchange. La conversión a euros se realiza en tiempo real en el terminal de pago. Gnosis Pay y MetaMask Card son las favoritas entre los usuarios de criptomonedas en España: sin cuenta custodial, cashback en cripto y compatibles con Apple Pay y Google Pay. Para quienes quieren cashback en bitcoin específicamente, Nexo Card devuelve entre el 1% y el 2% en BTC en cada compra, sin staking adicional. Con las tarjetas de criptomonedas disponibles en España en ${YEAR}, puedes gastar tu bitcoin directamente sin perder exposición al mercado.` },
    ],
    it: [
      ...
      { h2: `Carta bitcoin Italia ${YEAR}: spendere BTC e criptovalute ogni giorno`, p: `Una carta bitcoin in Italia ti permette di convertire il tuo BTC, ETH o USDC in acquisti quotidiani, supermercati, benzinai, Amazon, ristoranti, senza vendere preventivamente su un exchange. La conversione in euro avviene in tempo reale al terminale di pagamento. Gnosis Pay e MetaMask Card sono le preferite dagli utenti di criptovalute in Italia: senza conto custodiale, cashback in cripto e compatibili con Apple Pay e Google Pay. Per chi vuole cashback specificamente in bitcoin, Nexo Card restituisce tra l'1% e il 2% in BTC su ogni acquisto, senza staking aggiuntivo. Con le carte crypto disponibili in Italia nel ${YEAR}, puoi spendere il tuo bitcoin direttamente senza perdere esposizione al mercato.` },
      { h2: `Young Platform: la piattaforma crypto italiana per chi inizia`, p: `Young Platform è la principale piattaforma crypto fondata in Italia, a Torino nel 2019, e rappresenta il punto di ingresso preferito da migliaia di italiani nel mondo delle criptovalute. A differenza delle piattaforme internazionali, Young Platform è pensata per il pubblico italiano: interfaccia in italiano, supporto in italiano, conformità OAM, e una community attiva. La piattaforma offre l'acquisto di Bitcoin, Ethereum e oltre 200 criptovalute, con commissioni competitive. Per chi vuole abbinare un exchange affidabile a una carta crypto internazionale, un approccio comune è usare Young Platform per accumulare e Crypto.com Visa o Nexo Card per spendere quotidianamente, combinando il meglio dell'ecosistema italiano e internazionale.` },
    ],
    en: [
  ...
  iban: {
    fr: [
      { h2: `Qu'est-ce qu'une carte crypto avec IBAN ?`, p: `Une carte crypto avec IBAN combine les fonctionnalités d'un compte bancaire classique avec les avantages des cryptomonnaies. L'IBAN (International Bank Account Number) vous permet de recevoir des virements bancaires, des salaires et des paiements SEPA, tout comme un compte courant traditionnel. La différence : votre argent est géré en lien avec des cryptomonnaies, et chaque dépense avec la carte génère du cashback en crypto. En France, Deblock est la seule néobanque crypto avec un IBAN FR complet et une régulation ACPR, ce qui signifie que vous recevez un vrai RIB français, utilisable pour domicilier votre salaire ou vos prélèvements.` },
      { h2: `Deblock, Brighty, Revolut : quelle carte IBAN choisir en ${YEAR} ?`, p: `Les principales cartes crypto avec IBAN en ${YEAR} : Deblock (IBAN FR, ACPR, cashback 1% en Premium à 9,90€/mois), Brighty (IBAN EU, réglementé FINMA, cashback en USDC), Revolut (IBAN local selon pays, cashback en crypto sur Premium). Deblock est le seul acteur avec un IBAN français, essentiel pour domicilier son salaire en France. Brighty est idéal pour ceux qui souhaitent un compte crypto suisse avec virements internationaux. Revolut offre l'écosystème le plus complet mais avec des fonctions crypto limitées sur le plan de base.` },
      { h2: `Fiscalité des retraits et virements SEPA : ce qu'il faut savoir`, p: `Avec une carte crypto avec IBAN, les virements SEPA en euros ne déclenchent pas d'imposition. En revanche, si vous rechargez votre compte IBAN en convertissant des cryptos en euros, la conversion constitue une cession imposable (flat tax 30% en France). Pour éviter cela, certaines cartes comme Deblock permettent de maintenir un solde en euros séparé du portefeuille crypto. Consultez un conseiller fiscal pour votre situation personnelle, les règles varient selon la manière dont la carte gère la conversion crypto/euro.` },
    ],
    de: [
      { h2: `Was ist eine Krypto-Karte mit IBAN?`, p: `Eine Krypto-Karte mit IBAN kombiniert die Funktionen eines klassischen Bankkontos mit den Vorteilen von Kryptowährungen. Die IBAN ermöglicht Ihnen, Bankübertragungen, Gehalt und SEPA-Zahlungen zu empfangen, genau wie ein herkömmliches Girokonto. Der Unterschied: Ihr Geld wird in Verbindung mit Kryptowährungen verwaltet, und jeder Kartenkauf generiert Krypto-Cashback. Für Deutschland sind Brighty (europäische IBAN, FINMA-reguliert) und Revolut (lokale IBAN je nach Land) die wichtigsten Optionen neben internationalen Anbietern.` },
      { h2: `Brighty, Revolut, Bitpanda: Welche IBAN-Krypto-Karte in ${YEAR}?`, p: `Die wichtigsten Krypto-Karten mit IBAN in ${YEAR}: Brighty (CH/EU-IBAN, FINMA, Cashback in USDC), Revolut (lokale IBAN, Cashback in Krypto auf Premium), Bitpanda (österreichische Plattform, FMA-reguliert, Bankfunktionen). Für deutsche Nutzer bietet Revolut die umfassendste Lösung mit lokaler IBAN und Krypto-Integration. Brighty ist ideal für grenzüberschreitende Zahlungen mit europäischer IBAN. Vergleichen Sie nach Regulierung, Cashback und IBAN-Typ.` },
      { h2: `SEPA-Überweisungen und Steuern: Was Sie wissen müssen`, p: `Mit einer Krypto-Karte mit IBAN lösen SEPA-Überweisungen in Euro keine Besteuerung aus. Wenn Sie Ihr IBAN-Konto jedoch durch Umwandlung von Krypto in Euro aufladen, gilt die Konvertierung in Deutschland als privates Veräußerungsgeschäft (§ 23 EStG): Nach einer Haltefrist von einem Jahr sind Gewinne steuerfrei, davor gilt Ihr persönlicher Einkommensteuersatz (Freigrenze 1.000 € pro Jahr). Einige Karten ermöglichen es, ein Euro-Guthaben getrennt vom Krypto-Portfolio zu führen, so vermeiden Sie unbeabsichtigte steuerpflichtige Ereignisse. Konsultieren Sie einen Steuerberater für Ihre persönliche Situation.` },
    ],
    es: [
      { h2: `¿Qué es una tarjeta crypto con IBAN?`, p: `Una tarjeta crypto con IBAN combina las funciones de una cuenta bancaria tradicional con las ventajas de las criptomonedas. El IBAN te permite recibir transferencias bancarias, nóminas y pagos SEPA, igual que una cuenta corriente estándar. La diferencia: tu dinero se gestiona vinculado a criptomonedas y cada compra con la tarjeta genera cashback en crypto. En España en ${YEAR}, las principales opciones con IBAN son Brighty (IBAN europeo, regulado por FINMA), Revolut (IBAN local, cripto en Premium) y Gnosis Pay (IBAN en blockchain, cashback en GNO).` },
      { h2: `Brighty, Revolut, Gnosis Pay: ¿qué tarjeta IBAN crypto elegir en ${YEAR}?`, p: `Las principales tarjetas crypto con IBAN disponibles en España en ${YEAR}: Brighty (IBAN EU, regulado FINMA, cashback en USDC), Revolut (IBAN local, cashback en crypto en Premium desde 9,99€/mes), Gnosis Pay (IBAN en blockchain, cashback en GNO sin staking). Para domiciliar la nómina, Revolut ofrece el IBAN más extendido en España. Brighty es la mejor opción para pagos internacionales con cuenta suiza. Compara el tipo de IBAN (nacional vs europeo) y el tipo de cashback antes de elegir.` },
      { h2: `Fiscalidad de las retiradas y transferencias SEPA: lo que debes saber`, p: `Con una tarjeta crypto con IBAN, las transferencias SEPA en euros no generan tributación. En cambio, si recargas tu cuenta IBAN convirtiendo criptomonedas a euros, la conversión constituye una alteración patrimonial sujeta al IRPF en la base del ahorro (del 19% al 28% según el importe). Para evitarlo, algunas tarjetas permiten mantener un saldo en euros separado de la cartera crypto. Recuerda también la casilla de criptomonedas en la declaración de la renta y el modelo 721 para saldos en el extranjero. Consulta a un asesor fiscal para tu situación personal.` },
    ],
    it: [
      { h2: `Cos'è una carta crypto con IBAN?`, p: `Una carta crypto con IBAN combina le funzionalità di un conto bancario tradizionale con i vantaggi delle criptovalute. L'IBAN ti permette di ricevere bonifici bancari, stipendi e pagamenti SEPA, proprio come un conto corrente standard. La differenza: il tuo denaro è gestito in connessione con criptovalute e ogni acquisto con la carta genera cashback in crypto. In Italia nel ${YEAR}, le principali opzioni con IBAN sono Brighty (IBAN europeo, regolamentato FINMA), Revolut (IBAN locale, cripto in Premium) e Young Platform (piattaforma italiana, OAM registrata).` },
      { h2: `Brighty, Revolut, Young Platform: quale carta IBAN crypto scegliere nel ${YEAR}?`, p: `Le principali carte crypto con IBAN disponibili in Italia nel ${YEAR}: Brighty (IBAN EU, regolamentato FINMA, cashback in USDC), Revolut (IBAN locale, cashback in crypto su Premium), Young Platform (piattaforma italiana, OAM registrata, funzioni bancarie integrate). Per domiciliare lo stipendio, Revolut offre l'IBAN locale più diffuso in Italia. Brighty è la scelta migliore per pagamenti internazionali. Young Platform è l'unica piattaforma crypto nativa italiana, ideale per chi preferisce un servizio completamente in italiano con supporto locale.` },
      { h2: `Fiscalità dei prelievi e bonifici SEPA: cosa sapere`, p: `Con una carta crypto con IBAN, i bonifici SEPA in euro non generano tassazione. Se invece ricarichi il conto IBAN convertendo criptovalute in euro, la conversione costituisce una cessione imponibile: in Italia le plusvalenze crypto sono soggette all'imposta sostitutiva del 26%. Per evitarlo, alcune carte permettono di mantenere un saldo in euro separato dal portafoglio crypto. Ricorda anche il quadro RW per il monitoraggio fiscale degli asset detenuti su piattaforme estere. Consulta un commercialista per la tua situazione personale.` },
    ],
    en: [
      { h2: `What is a crypto card with IBAN?`, p: `A crypto card with IBAN combines the features of a traditional bank account with the benefits of cryptocurrency. The IBAN enables you to receive bank transfers, salaries, and SEPA payments, just like a standard current account. The difference: your money is managed in connection with cryptocurrencies, and every card purchase earns crypto cashback. The main crypto cards with IBAN available in Europe in ${YEAR} are Brighty (EU IBAN, FINMA-regulated, USDC cashback), Revolut (local IBAN by country, crypto cashback on Premium), and Deblock (FR IBAN, ACPR-regulated).` },
      { h2: `Brighty, Revolut, Deblock: which IBAN crypto card to choose in ${YEAR}?`, p: `The key crypto cards with IBAN in ${YEAR}: Brighty (CH/EU IBAN, FINMA regulated, cashback in USDC), Revolut (local IBAN per country, crypto cashback on Premium), Deblock (FR IBAN, ACPR regulated, 1% cashback on Premium at €9.90/month). Choose Deblock if you need a French IBAN for salary domiciliation in France. Choose Brighty for a Swiss-based account with cross-border transfers. Choose Revolut for the most complete multi-currency ecosystem across Europe.` },
    ],
  },
};

// Propagate be→fr and at→de content aliases into THEME_CONFIG (skip if explicit be/at already set)
...
// Propagate be→fr and at→de content aliases into THEME_SECTIONS (skip if explicit be/at already set)
for (const theme of Object.keys(THEME_SECTIONS)) {
  const t = THEME_SECTIONS[theme] as Record<string, unknown>;
  if (t && t.fr && !t.be) t.be = t.fr;
  if (t && t.de && !t.at) t.at = t.de;
}
...
const THEME_FAQ: Record<string, Record<string, { q: string; a: string }[]>> = {
  ...
  belgium: {
    fr: [
      { q:'Quelles cartes crypto sont disponibles en Belgique ?', a:`En ${YEAR}, les principales cartes crypto disponibles en Belgique sont : Bybit Card, Crypto.com Visa, Nexo Card, Gnosis Pay, Brighty, MetaMask Card et Wirex. La Belgique fait partie de l'EEE et bénéficie du cadre MiCA.` },
      { q:'Les cartes crypto sont-elles légales en Belgique ?', a:"Oui. Depuis l'entrée en vigueur de MiCA en 2024, les émetteurs de cartes crypto opèrent sous licence européenne unifiée. La FSMA (Autorité belge des services et marchés financiers) supervise la conformité locale." },
      { q:'Faut-il déclarer une carte crypto aux impôts en Belgique ?', a:"Oui. Les comptes détenus auprès d'établissements étrangers doivent être déclarés au Point de Contact Central (PCC) de la Banque Nationale. Les plus-values crypto sont imposées selon votre profil fiscal (particulier ou professionnel)." },
      { q:'Y a-t-il des restrictions spécifiques à la Belgique pour les cartes crypto ?', a:"La Belgique impose des règles strictes en matière de publicité pour les cryptoactifs. Certaines offres promotionnelles de cashback peuvent être limitées ou différentes de la version française." },
      { q:'Quelle est la meilleure carte crypto pour un résident belge ?', a:"Bybit Card (jusqu'à 10% sans staking) et Gnosis Pay (5% en GNO, self-custody) sont les meilleures options pour les résidents belges cherchant un bon cashback sans contraintes de staking." },
    ],
    de: [
      { q:'Welche Krypto-Karten sind in Belgien verfügbar?', a:`In ${YEAR} sind in Belgien verfügbar: Bybit Card, Crypto.com Visa, Nexo Card, Gnosis Pay, Brighty, MetaMask Card und Wirex. Belgien ist Teil des EWR und profitiert vom MiCA-Rahmen.` },
      { q:'Sind Krypto-Karten in Belgien legal?', a:'Ja. Seit MiCA 2024 agieren Krypto-Kartenemittenten unter einheitlicher europäischer Lizenz. Die FSMA überwacht die lokale Compliance.' },
      { q:'Muss man eine Krypto-Karte in Belgien beim Finanzamt melden?', a:'Ja. Im Ausland gehaltene Konten müssen beim Zentralen Kontaktpunkt (PCC) der Nationalbank gemeldet werden. Krypto-Gewinne werden je nach Steuerprofil besteuert.' },
      { q:'Gibt es belgienspezifische Einschränkungen für Krypto-Karten?', a:'Belgien hat strenge Werberegeln für Kryptoassets. Einige Cashback-Aktionen können eingeschränkt oder anders als in der französischen Version sein.' },
      { q:'Welche ist die beste Krypto-Karte für belgische Einwohner?', a:'Bybit Card (bis 10% ohne Staking) und Gnosis Pay (5% in GNO, Self-Custody) sind die besten Optionen für belgische Einwohner, die gutes Cashback ohne Staking-Verpflichtungen suchen.' },
    ],
    es: [
      { q:'¿Qué tarjetas crypto están disponibles en Bélgica?', a:`En ${YEAR}, las principales tarjetas crypto disponibles en Bélgica son: Bybit Card, Crypto.com Visa, Nexo Card, Gnosis Pay, Brighty, MetaMask Card y Wirex. Bélgica forma parte del EEE y se beneficia del marco MiCA.` },
      { q:'¿Son legales las tarjetas crypto en Bélgica?', a:'Sí. Desde MiCA en 2024, los emisores operan bajo licencia europea unificada. La FSMA supervisa el cumplimiento local.' },
      { q:'¿Hay que declarar una tarjeta crypto a Hacienda en Bélgica?', a:'Sí. Las cuentas en el extranjero deben declararse al Punto de Contacto Central (PCC) del Banco Nacional. Las plusvalías crypto se gravan según tu perfil fiscal.' },
      { q:'¿Hay restricciones específicas en Bélgica para tarjetas crypto?', a:'Bélgica tiene reglas estrictas sobre publicidad de criptoactivos. Algunas ofertas de cashback pueden estar limitadas.' },
      { q:'¿Cuál es la mejor tarjeta crypto para residentes en Bélgica?', a:"Bybit Card (hasta 10% sin staking) y Gnosis Pay (5% en GNO, autocustodia) son las mejores opciones para residentes belgas que buscan buen cashback sin staking." },
    ],
    it: [
      { q:'Quali carte crypto sono disponibili in Belgio?', a:`Nel ${YEAR}, le principali carte crypto disponibili in Belgio sono: Bybit Card, Crypto.com Visa, Nexo Card, Gnosis Pay, Brighty, MetaMask Card e Wirex. Il Belgio fa parte del SEE e beneficia del quadro MiCA.` },
      { q:'Le carte crypto sono legali in Belgio?', a:'Sì. Da MiCA nel 2024, gli emittenti operano sotto licenza europea unificata. La FSMA supervisiona la conformità locale.' },
      { q:'Bisogna dichiarare una carta crypto al fisco in Belgio?', a:'Sì. I conti detenuti presso istituti esteri devono essere dichiarati al Punto di Contatto Centrale (PCC) della Banca Nazionale. Le plusvalenze crypto vengono tassate in base al profilo fiscale.' },
      { q:'Esistono restrizioni specifiche in Belgio per le carte crypto?', a:'Il Belgio ha regole severe sulla pubblicità di criptoasset. Alcune offerte cashback possono essere limitate.' },
      { q:"Qual è la migliore carta crypto per i residenti in Belgio?", a:"Bybit Card (fino al 10% senza staking) e Gnosis Pay (5% in GNO, self-custody) sono le migliori opzioni per i residenti belgi che cercano un buon cashback senza staking." },
    ],
    en: [
      { q:'Which crypto cards are available in Belgium?', a:`In ${YEAR}, the main crypto cards available in Belgium are: Bybit Card, Crypto.com Visa, Nexo Card, Gnosis Pay, Brighty, MetaMask Card, and Wirex. Belgium is part of the EEA and benefits from the MiCA framework.` },
      { q:'Are crypto cards legal in Belgium?', a:'Yes. Since MiCA came into effect in 2024, crypto card issuers operate under a unified European licence. The FSMA (Financial Services and Markets Authority) oversees local compliance.' },
      { q:'Do you need to declare a crypto card to Belgian tax authorities?', a:'Yes. Accounts held with foreign institutions must be reported to the Central Point of Contact (PCC) at the National Bank. Crypto gains are taxed depending on your tax profile.' },
      { q:'Are there Belgium-specific restrictions on crypto cards?', a:'Belgium has strict advertising rules for crypto assets. Some cashback promotional offers may be restricted or differ from other markets.' },
      { q:'What is the best crypto card for Belgian residents?', a:"Bybit Card (up to 10% with no staking) and Gnosis Pay (5% in GNO, self-custody) are the top choices for Belgian residents seeking strong cashback without staking requirements." },
    ],
  },
  austria: {
    fr: [
      { q:'Quelles cartes crypto sont disponibles en Autriche ?', a:`En ${YEAR}, les principales cartes crypto disponibles en Autriche sont : Bybit Card, Bitpanda Card (entreprise autrichienne), Crypto.com Visa, Nexo Card, Gnosis Pay, Trade Republic et Brighty. La Bitpanda Card bénéficie d'un avantage local évident.` },
      { q:'Les cartes crypto sont-elles légales en Autriche ?', a:"Oui. La FMA (Finanzmarktaufsicht) réglemente les services crypto en Autriche. Depuis MiCA, les émetteurs opèrent sous passeportage européen unifié." },
      { q:'Faut-il déclarer une carte crypto aux impôts autrichiens ?', a:"Oui. En Autriche, les gains crypto sont soumis à l'impôt spécial sur les revenus de capital (KESt) de 27,5%. Les pertes sont déductibles. Consultez un conseiller fiscal pour votre situation." },
      { q:'La Bitpanda Card est-elle vraiment la meilleure en Autriche ?', a:"Bitpanda est fondée à Vienne et est la plus grande plateforme crypto d'Autriche. Sa carte offre jusqu'à 1% de cashback en BEST sans staking obligatoire, avec un support en allemand et une interface très adaptée au marché local." },
      { q:'Quelle est la meilleure carte crypto pour un résident autrichien ?', a:"Bybit Card (jusqu'à 10% sans staking), Bitpanda Card (avantage local, support DE) et Trade Republic (1% en ETF pour épargne automatique) couvrent les trois profils principaux en Autriche." },
    ],
    de: [
      { q:'Welche Krypto-Karten sind in Österreich verfügbar?', a:`In ${YEAR} sind die wichtigsten Krypto-Karten in Österreich: Bybit Card, Bitpanda Card (österreichisches Unternehmen), Crypto.com Visa, Nexo Card, Gnosis Pay, Trade Republic und Brighty. Die Bitpanda Card hat einen klaren lokalen Vorteil.` },
      { q:'Sind Krypto-Karten in Österreich legal?', a:'Ja. Die FMA (Finanzmarktaufsicht) reguliert Krypto-Dienste in Österreich. Seit MiCA agieren Emittenten unter einheitlichem EU-Passporting.' },
      { q:'Muss man Krypto-Karten in Österreich beim Finanzamt melden?', a:'Ja. In Österreich unterliegen Krypto-Gewinne der Kapitalertragsteuer (KESt) von 27,5%. Verluste können abgezogen werden. Konsultieren Sie einen Steuerberater.' },
      { q:'Ist die Bitpanda Card wirklich die beste in Österreich?', a:'Bitpanda wurde in Wien gegründet und ist die größte Krypto-Plattform Österreichs. Die Karte bietet bis zu 1% Cashback in BEST ohne obligatorisches Staking, mit deutschem Support.' },
      { q:'Welche ist die beste Krypto-Karte für österreichische Einwohner?', a:'Bybit Card (bis 10% ohne Staking), Bitpanda Card (lokaler Vorteil, DE-Support) und Trade Republic (1% ETF-Sparrate) decken die drei Hauptprofile in Österreich ab.' },
    ],
    es: [
      { q:'¿Qué tarjetas crypto están disponibles en Austria?', a:`En ${YEAR}, las principales tarjetas crypto en Austria son: Bybit Card, Bitpanda Card (empresa austriaca), Crypto.com Visa, Nexo Card, Gnosis Pay, Trade Republic y Brighty.` },
      { q:'¿Son legales las tarjetas crypto en Austria?', a:'Sí. La FMA regula los servicios crypto en Austria. Desde MiCA, los emisores operan bajo pasaporto europeo unificado.' },
      { q:'¿Hay que declarar ganancias crypto en Austria?', a:'Sí. En Austria, las ganancias crypto están sujetas al impuesto sobre rendimientos de capital (KESt) del 27,5%. Las pérdidas son deducibles.' },
      { q:'¿Es Bitpanda Card la mejor en Austria?', a:'Bitpanda fue fundada en Viena y es la mayor plataforma crypto de Austria. Su tarjeta ofrece hasta 1% de cashback en BEST sin staking obligatorio, con soporte en alemán.' },
      { q:'¿Cuál es la mejor tarjeta crypto para residentes en Austria?', a:'Bybit Card (hasta 10% sin staking), Bitpanda Card (ventaja local) y Trade Republic (1% en ETF) cubren los tres perfiles principales en Austria.' },
    ],
    it: [
      { q:'Quali carte crypto sono disponibili in Austria?', a:`Nel ${YEAR}, le principali carte crypto in Austria sono: Bybit Card, Bitpanda Card (azienda austriaca), Crypto.com Visa, Nexo Card, Gnosis Pay, Trade Republic e Brighty.` },
      { q:'Le carte crypto sono legali in Austria?', a:'Sì. La FMA regola i servizi crypto in Austria. Da MiCA, gli emittenti operano sotto passaporto europeo unificato.' },
      { q:'Bisogna dichiarare i guadagni crypto in Austria?', a:"Sì. In Austria, i guadagni crypto sono soggetti all'imposta sui redditi da capitale (KESt) del 27,5%. Le perdite sono deducibili." },
      { q:'Bitpanda Card è davvero la migliore in Austria?', a:'Bitpanda è stata fondata a Vienna ed è la più grande piattaforma crypto austriaca. La carta offre fino all\'1% di cashback in BEST senza staking obbligatorio, con supporto in tedesco.' },
      { q:'Qual è la migliore carta crypto per i residenti in Austria?', a:'Bybit Card (fino al 10% senza staking), Bitpanda Card (vantaggio locale) e Trade Republic (1% in ETF) coprono i tre profili principali in Austria.' },
    ],
    en: [
      { q:'Which crypto cards are available in Austria?', a:`In ${YEAR}, the main crypto cards available in Austria are: Bybit Card, Bitpanda Card (Austrian company), Crypto.com Visa, Nexo Card, Gnosis Pay, Trade Republic, and Brighty.` },
      { q:'Are crypto cards legal in Austria?', a:'Yes. The FMA (Finanzmarktaufsicht) regulates crypto services in Austria. Since MiCA, issuers operate under unified EU passporting.' },
      { q:'Do you need to declare crypto gains in Austria?', a:'Yes. In Austria, crypto gains are subject to capital gains tax (KESt) at 27.5%. Losses can be offset. Consult a tax advisor for your specific situation.' },
      { q:'Is the Bitpanda Card really the best in Austria?', a:'Bitpanda was founded in Vienna and is Austria\'s largest crypto platform. The card offers up to 1% cashback in BEST with no mandatory staking, and full German-language support.' },
      { q:'What is the best crypto card for Austrian residents?', a:"Bybit Card (up to 10% with no staking), Bitpanda Card (local advantage, German support), and Trade Republic (1% ETF Saveback) cover the three main user profiles in Austria." },
    ],
  },
  iban: {
    fr: [
      { q:'Qu\'est-ce qu\'une carte crypto avec IBAN ?', a:`Une carte crypto avec IBAN intègre un compte bancaire IBAN européen (SEPA) directement lié à vos actifs crypto. En ${YEAR}, Brighty, Deblock et Gnosis Pay proposent ce type de compte, permettant de recevoir un salaire, de faire des virements SEPA et d'utiliser une carte Visa/Mastercard crypto.` },
      { q:'Quelle carte crypto propose un IBAN en ${YEAR} ?', a:`En ${YEAR}, les meilleures options sont : Brighty (IBAN CH, virements SEPA gratuits), Deblock (IBAN FR, intégration DeFi), Gnosis Pay (compte on-chain avec IBAN), et Revolut (IBAN EU en option crypto). Brighty est particulièrement adaptée pour les résidents français.` },
      { q:'Un IBAN crypto est-il sûr ?', a:'Oui, à condition de choisir un émetteur régulé MiCA ou agréé EMI (établissement de monnaie électronique). Brighty est agréée par FINMA (Suisse), Deblock est supervisée par l\'ACPR en France. Les fonds sont ségrégués de l\'opérateur.' },
      { q:'Peut-on recevoir son salaire sur un IBAN crypto ?', a:'Oui. Brighty et Deblock acceptent les virements SEPA entrants (salaires, remboursements). Vous pouvez ensuite convertir en crypto ou payer directement avec votre carte.' },
      { q:'Quelle différence entre un IBAN crypto et un compte bancaire classique ?', a:'Un IBAN crypto vous permet de gérer cryptos et euros au même endroit, souvent avec des frais de conversion inférieurs (0–0,5%) et un accès DeFi. En revanche, il ne bénéficie pas de la garantie des dépôts FGDR (jusqu\'à 100 000€ pour les banques classiques).' },
    ],
    de: [
      { q:`Was ist eine Krypto-Karte mit IBAN in ${YEAR}?`, a:`Eine Krypto-Karte mit IBAN kombiniert ein europäisches Bankkonto (SEPA-IBAN) mit Krypto-Assets. In ${YEAR} bieten Brighty, Gnosis Pay und Revolut diesen Service: Sie können Ihr Gehalt empfangen, SEPA-Überweisungen tätigen und direkt mit Ihrer Krypto-Karte bezahlen.` },
      { q:'Welche Krypto-Karte bietet eine IBAN in Deutschland?', a:`Brighty (CH-IBAN, kostenlose SEPA-Überweisungen), Gnosis Pay (on-chain IBAN), Revolut (EU-IBAN mit Krypto-Option) und Bitpanda (in Entwicklung) sind die führenden Anbieter in ${YEAR}. Für deutschsprachige Nutzer empfiehlt sich Brighty oder Revolut.` },
      { q:'Ist eine Krypto-IBAN sicher?', a:'Ja, wenn der Anbieter reguliert ist. Brighty ist bei der FINMA (Schweiz) lizenziert, Revolut hat eine europäische Banklizenz. Ihre Gelder sind vom Betriebskapital des Unternehmens getrennt (Segregation).' },
      { q:'Kann ich mein Gehalt auf eine Krypto-IBAN empfangen?', a:'Ja. Brighty und Revolut akzeptieren eingehende SEPA-Überweisungen (Gehalt, Erstattungen). Sie können das Geld dann in Krypto umwandeln oder direkt per Karte zahlen.' },
      { q:'Was kostet eine IBAN-Krypto-Karte?', a:'Die meisten Anbieter bieten eine Basis-IBAN kostenlos an. Brighty: 0€ Jahresgebühr mit kostenloser IBAN. Revolut: kostenloser Plan verfügbar. Deblock: monatliche Gebühr für Premium-Features.' },
    ],
    es: [
      { q:`¿Qué es una tarjeta crypto con IBAN en ${YEAR}?`, a:`Una tarjeta crypto con IBAN combina una cuenta bancaria europea (IBAN SEPA) con criptoactivos. En ${YEAR}, Brighty, Gnosis Pay y Revolut ofrecen este servicio: puede recibir su nómina, hacer transferencias SEPA y pagar directamente con su tarjeta crypto.` },
      { q:'¿Qué tarjeta crypto ofrece IBAN en España?', a:`Brighty (IBAN CH, transferencias SEPA gratuitas), Revolut (IBAN EU con opción crypto) y Gnosis Pay (IBAN on-chain) son las mejores opciones en ${YEAR}. Revolut es especialmente popular por su soporte en español y su app intuitiva.` },
      { q:'¿Es seguro un IBAN crypto?', a:'Sí, si el proveedor está regulado. Brighty cuenta con licencia FINMA (Suiza), Revolut tiene licencia bancaria europea. Los fondos están segregados del capital operativo del proveedor.' },
      { q:'¿Puedo recibir mi nómina en un IBAN crypto?', a:'Sí. Brighty y Revolut aceptan transferencias SEPA entrantes (nóminas, reembolsos). Luego puede convertir a crypto o pagar directamente con su tarjeta.' },
      { q:'¿Cuánto cuesta una tarjeta crypto con IBAN?', a:'La mayoría ofrece IBAN básico gratuito. Brighty: 0€ de cuota anual con IBAN incluido. Revolut: plan gratuito disponible. Deblock: cuota mensual para funciones premium.' },
    ],
    it: [
      { q:`Cos'è una carta crypto con IBAN nel ${YEAR}?`, a:`Una carta crypto con IBAN combina un conto bancario europeo (IBAN SEPA) con criptoasset. Nel ${YEAR}, Brighty, Gnosis Pay e Revolut offrono questo servizio: è possibile ricevere lo stipendio, fare bonifici SEPA e pagare direttamente con la carta crypto.` },
      { q:'Quale carta crypto offre un IBAN in Italia?', a:`Brighty (IBAN CH, bonifici SEPA gratuiti), Revolut (IBAN EU con opzione crypto) e Gnosis Pay (IBAN on-chain) sono le migliori opzioni nel ${YEAR}. Revolut è particolarmente popolare in Italia per il supporto in italiano.` },
      { q:'Un IBAN crypto è sicuro?', a:"Sì, se il fornitore è regolamentato. Brighty ha la licenza FINMA (Svizzera), Revolut ha la licenza bancaria europea. I fondi sono separati dal capitale operativo del provider." },
      { q:'Posso ricevere il mio stipendio su un IBAN crypto?', a:'Sì. Brighty e Revolut accettano bonifici SEPA in entrata (stipendi, rimborsi). È poi possibile convertire in crypto o pagare direttamente con la carta.' },
      { q:'Quanto costa una carta crypto con IBAN?', a:'La maggior parte offre IBAN base gratuito. Brighty: 0€ di canone annuo con IBAN incluso. Revolut: piano gratuito disponibile. Deblock: canone mensile per funzioni premium.' },
    ],
    en: [
      { q:`What is a crypto card with IBAN in ${YEAR}?`, a:`A crypto card with IBAN combines a European bank account (SEPA IBAN) with crypto assets. In ${YEAR}, Brighty, Gnosis Pay, and Revolut offer this service: you can receive your salary, make SEPA transfers, and pay directly with your crypto card.` },
      { q:'Which crypto card offers an IBAN in the UK?', a:`Brighty (CH IBAN, free SEPA transfers), Revolut (EU IBAN with crypto option), and Gnosis Pay (on-chain IBAN) are the top options in ${YEAR}. Revolut is especially popular for UK users given its full GBP support and bank-level features.` },
      { q:'Is a crypto IBAN safe?', a:'Yes, if the provider is regulated. Brighty holds a FINMA licence (Switzerland), Revolut has a full European banking licence. Your funds are segregated from the company\'s operational capital.' },
      { q:'Can I receive my salary on a crypto IBAN?', a:'Yes. Brighty and Revolut accept incoming SEPA transfers (salary, reimbursements). You can then convert to crypto or pay directly with your card.' },
      { q:'How much does a crypto card with IBAN cost?', a:'Most providers offer a basic IBAN for free. Brighty: €0 annual fee with IBAN included. Revolut: free plan available. Deblock: monthly fee for premium features.' },
    ],
  },
};

// Propagate be→fr and at→de content aliases into THEME_FAQ (skip if explicit be/at already set)
...
const THEME_SORT: Record<string, (a: any, b: any) => number> = {
  ...
  iban:         (a, b) => (b.trust_score || 0) - (a.trust_score || 0),
};
...
const THEMATIC_SLUGS: Record<string, Record<string, string>> = {
  ...
  iban:         { fr: 'carte-crypto-avec-iban', be: 'carte-crypto-avec-iban', de: 'krypto-karte-mit-iban', at: 'krypto-karte-mit-iban', es: 'tarjeta-crypto-con-iban', it: 'carta-crypto-con-iban', en: 'crypto-card-with-iban' },
};
