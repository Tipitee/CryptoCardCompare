...
const CONTENT: Record<string, {
  ...
  pt: {
    title: 'Resumo dos riscos cripto',
    readTime: 'Tempo de leitura estimado: 2 minutos',
    euTitle: 'Versão UE / Portugal',
    warningTitle: 'Aviso sobre os riscos (MiCA / UE)',
    warningText: 'Os criptoativos são produtos altamente especulativos. O seu valor pode variar consideravelmente e podes perder a totalidade do capital investido. Os criptoativos geralmente não beneficiam das proteções oferecidas aos produtos financeiros regulados.',
    sections: [
      { h: 'Podes perder a totalidade do teu investimento', p: ['Os criptoativos são extremamente voláteis. O valor dos tokens pode cair de forma brusca e rápida. O desempenho passado não garante o desempenho futuro.', 'Isto aplica-se também aos criptoativos recebidos como cashback num cartão crypto. Se receberes recompensas em tokens (CRO, GNO, BNB, PLU ou outros), o seu valor pode diminuir significativamente antes de os poderes usar ou converter.'] },
      { h: 'Geralmente não estás protegido pelas garantias bancárias', p: ['Os produtos cripto não beneficiam da proteção de depósitos oferecida pelos bancos regulados na UE (diretiva 2014/49/UE, até 100 000 €). Alguns emissores detêm uma licença de instituição de moeda eletrónica, mas essas proteções não abrangem os criptoativos.', 'Em Portugal, o Banco de Portugal supervisiona os prestadores de serviços de criptoativos. Ao abrigo do MiCA (Regulamento (UE) 2023/1114), os prestadores de serviços de criptoativos têm de estar autorizados. Registo público: www.bportugal.pt'] },
      { h: 'Podes não conseguir vender ou converter quando quiseres', p: ['Alguns tokens têm baixo volume de negociação ou liquidez limitada. Os cartões que exigem staking bloqueiam o teu capital durante um período determinado.'] },
      { h: 'Os produtos cripto são complexos', p: 'Os cartões crypto combinam um cartão de pagamento (regulado), um criptoativo (parcialmente regulado ao abrigo do MiCA), um programa de recompensas e, em alguns casos, um mecanismo de staking. Não subscrevas um produto que não compreendas totalmente.' },
      { h: 'Não ponhas todos os ovos no mesmo cesto', p: 'Só investe fundos cuja perda total possas suportar. As autoridades financeiras europeias recomendam não investir uma parte significativa das tuas poupanças em criptoativos.' },
      { h: 'Este site não constitui aconselhamento financeiro', p: 'A TopCryptoCards é uma publicação editorial independente. Os nossos conteúdos não constituem aconselhamento financeiro personalizado. Não estamos autorizados pelo Banco de Portugal nem por qualquer outra autoridade de supervisão financeira. Consulta um consultor financeiro autorizado se necessário.' },
    ],
    ukTitle: 'Version UK (FCA)',
    ukWarningTitle: 'FCA Risk warning',
    ukWarningText: 'Don\'t invest unless you\'re prepared to lose all the money you invest. Crypto is a high-risk investment and you are unlikely to be protected if something goes wrong.',
    ...
    noAdvice: 'Sem aconselhamento financeiro.',
  },
  de: {
