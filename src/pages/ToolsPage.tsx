...
const COPY: Record<string, {
  ...
  pt: {
    title:   `Ferramentas Gratuitas para Cartões Crypto ${YEAR}, Calculadoras e Comparadores | TopCryptoCards`,
    h1:      `Ferramentas gratuitas para escolher o teu cartão crypto`,
    desc:    `Calculadoras, simuladores e comparadores de cartões crypto gratuitos. Estima o teu cashback anual, compara as taxas e encontra o melhor cartão para o teu perfil.`,
    intro:   `Todas as nossas ferramentas são 100 % gratuitas, sem registo. Também podem ser integradas no teu site com um simples código iframe.`,
    tools: [
      { icon: '💳', name: `Calculadora de Cashback ${YEAR}`,  tagline: 'Introduz os teus gastos mensais → classificação instantânea dos cartões por cashback anual', cta: 'Calcular o meu cashback →' },
      { icon: '📊', name: `Calculadora de Taxas ${YEAR}`,     tagline: 'Compara as taxas anuais reais de cada cartão (subscrição, levantamento, conversão)', cta: 'Comparar as taxas →' },
      { icon: '🎯', name: 'Simulador por categorias',          tagline: 'Reparte os teus gastos (viagem, restaurante, compras…) para um resultado personalizado', cta: 'Simular os meus gastos →' },
      { icon: '⚡', name: 'Recomendação em 30 segundos',       tagline: 'Responde a 5 perguntas: o nosso algoritmo identifica o teu cartão ideal', cta: 'Encontrar o meu cartão →' },
      { icon: '⚖️', name: 'Comparador lado a lado',            tagline: 'Compara até 4 cartões em simultâneo em todos os critérios', cta: 'Comparar os cartões →' },
      { icon: '📋', name: `Índice de taxas ${YEAR}`,           tagline: 'Tabela completa das taxas de todos os cartões crypto disponíveis na Europa', cta: 'Ver as taxas →' },
    ],
    widgetTitle: 'Integrar o widget no teu site',
    widgetDesc:  'Cola este código em qualquer página para mostrar uma calculadora de cashback interativa com backlink automático.',
    widgetCopy:   'Copiar o código',
