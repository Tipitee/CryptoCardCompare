...
const HOME_SEO: Record<string, { title: string; desc: string }> = {
  ...
  es: { title: `Tarjeta Criptomonedas España ${YEAR}, Cashback | TopCryptoCards`, desc: `Compara 90+ tarjetas cripto en España ${YEAR}: hasta 8% cashback en BTC, sin cuota anual, sin staking. Gnosis Pay, Crypto.com, Nexo. Gratis ✓` },
