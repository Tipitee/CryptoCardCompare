...
export const ROUTE_TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  pt: {
    ...
    contact:        'contacto',
    authors:        'autores',
    feeIndex:           'taxas-cartoes-crypto',
    cashbackCalculator: 'calculadora-cashback-cartao-crypto',
    feeCalculator:      'calculadora-taxas-cartao-crypto',
    tools:              'ferramentas-cartao-crypto',
  },
  it: {
    compare:        'confronto',
