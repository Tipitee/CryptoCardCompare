...
const COMPARISONS: Record<string, ComparisonSpecific> = {
  'bingx-metal-card-vs-bybit-card': {
    de_intro: "BingX Card und Bybit Card sind zwei Visa-Karten globaler Krypto-Börsen, beide je nach VIP-Status abhängig von Ihrem Handelsvolumen zugänglich. Der Unterschied liegt in der Cashback-Währung: Die BingX Card zahlt in **USDT** (einem Stablecoin mit stabilem Wert), während die Bybit Card je nach Programm in **BIT/Token** zahlt. Keine der beiden ist MiCA-lizenziert.",
    de_verdict: "Wählen Sie die **BingX Card**, wenn Sie ein planbares Cashback in USDT bevorzugen und bereits auf BingX aktiv sind. Bevorzugen Sie die **Bybit Card**, wenn Sie im Bybit-Ökosystem sind und deren Aktionsraten anstreben. Behalten Sie in beiden Fällen die monatlichen Obergrenzen und die fehlende MiCA-Regulierung im Blick — für eine in der EU regulierte Karte schauen Sie sich Bitpanda oder Nexo an.",
    de_faq: [{"q":"BingX Card oder Bybit Card: Welche hat das bessere Cashback?","a":"Die BingX Card erreicht 5 % (Metal-Karte, VIP 3), ausgezahlt in USDT; die Bybit Card weist bis zu 10 % aus, aber in Token und unter Bedingungen. Beim stabilen „realen“ Cashback ist die BingX Card in USDT planbarer."},{"q":"Sind diese Karten in Europa verfügbar?","a":"Ja, beide sind im EWR verfügbar, einschließlich Deutschland und Österreich. Die BingX Card ist hingegen in Großbritannien, den USA und den Niederlanden nicht verfügbar."}],
    es_intro: "BingX Card y Bybit Card son dos tarjetas Visa de exchanges cripto globales, ambas accesibles según un estatus VIP ligado a tu volumen de trading. La diferencia está en la moneda del cashback: la BingX Card paga en **USDT** (una stablecoin de valor estable), mientras que la Bybit Card paga en **BIT/tokens** según el programa. Ninguna de las dos tiene licencia MiCA.",
    es_verdict: "Elige la **BingX Card** si prefieres un cashback predecible en USDT y ya eres activo en BingX. Prefiere la **Bybit Card** si estás en el ecosistema Bybit y aspiras a sus tasas promocionales. En ambos casos, ten en cuenta los límites mensuales y la ausencia de regulación MiCA — para una tarjeta regulada en la UE, considera Bitpanda o Nexo.",
    es_faq: [{"q":"BingX Card o Bybit Card: ¿cuál tiene el mejor cashback?","a":"La BingX Card llega al 5 % (tarjeta Metal, VIP 3) pagado en USDT; la Bybit Card muestra hasta un 10 % pero en token y bajo condiciones. En cashback «real» estable, la BingX Card en USDT es más predecible."},{"q":"¿Están disponibles estas tarjetas en Europa?","a":"Sí, ambas están disponibles en el EEE, incluidos España, Francia, Alemania e Italia. La BingX Card, en cambio, no está disponible en el Reino Unido, Estados Unidos ni Países Bajos."}],
    it_intro: "BingX Card e Bybit Card sono due carte Visa di exchange crypto globali, entrambe accessibili in base a uno stato VIP legato al tuo volume di trading. La differenza sta nella valuta del cashback: la BingX Card paga in **USDT** (una stablecoin dal valore stabile), mentre la Bybit Card paga in **BIT/token** a seconda del programma. Nessuna delle due è licenziata MiCA.",
    it_verdict: "Scegli la **BingX Card** se privilegi un cashback prevedibile in USDT e sei già attivo su BingX. Preferisci la **Bybit Card** se sei nell'ecosistema Bybit e punti alle sue tariffe promozionali. In entrambi i casi, tieni presente i massimali mensili e l'assenza di regolamentazione MiCA — per una carta regolamentata nell'UE, guarda Bitpanda o Nexo.",
    it_faq: [{"q":"BingX Card o Bybit Card: quale ha il cashback migliore?","a":"La BingX Card arriva al 5 % (carta Metal, VIP 3) erogato in USDT; la Bybit Card indica fino al 10 % ma in token e sotto condizioni. In cashback «reale» stabile, la BingX Card in USDT è più prevedibile."},{"q":"Queste carte sono disponibili in Europa?","a":"Sì, entrambe sono disponibili nel SEE, inclusi Italia, Francia, Germania e Spagna. La BingX Card è invece non disponibile nel Regno Unito, negli Stati Uniti e nei Paesi Bassi."}],
    en_intro: "BingX Card and Bybit Card are two Visa cards from global crypto exchanges, both accessible based on a VIP status tied to your trading volume. The difference lies in the cashback currency: the BingX Card pays in **USDT** (a stablecoin with stable value), while the Bybit Card pays in **BIT/tokens** depending on the programme. Neither is MiCA-licensed.",
    en_verdict: "Choose the **BingX Card** if you prefer predictable cashback in USDT and are already active on BingX. Prefer the **Bybit Card** if you're in the Bybit ecosystem and target its promotional rates. In both cases, keep in mind the monthly caps and the lack of MiCA regulation — for an EU-regulated card, look at Bitpanda or Nexo.",
    en_faq: [{"q":"BingX Card or Bybit Card: which has the better cashback?","a":"The BingX Card reaches 5% (Metal card, VIP 3) paid in USDT; the Bybit Card advertises up to 10% but in a token and under conditions. For stable 'real' cashback, the BingX Card in USDT is more predictable."},{"q":"Are these cards available in Europe?","a":"Yes, both are available across the EEA. The BingX Card, however, is unavailable in the UK, US and Netherlands."}],
  ...
  'bingx-metal-card-vs-nexo-card': {
    de_intro: "BingX Card und Nexo Card stellen zwei Philosophien gegenüber. Die **BingX Card** ist eine Börsenkarte (Visa/Wirex) mit Cashback in USDT bis zu 5 %, an einen VIP-Status gebunden. Die **Nexo Card** stützt sich auf eine durch Ihre Kryptos besicherte Kreditlinie, mit bis zu 2 % Cashback ohne Staking und einem in Europa besser etablierten Emittenten.",
    de_verdict: "Die **Nexo Card** gewinnt bei Übersichtlichkeit und Verfügbarkeit (Cashback ohne Volumenbedingung, etablierterer Anbieter). Die **BingX Card** wird interessant, wenn Sie bereits VIP-Nutzer von BingX sind und ein Cashback in USDT möchten. Für regulatorische Sicherheit behält Nexo den Vorteil.",
    es_intro: "BingX Card y Nexo Card enfrentan dos filosofías. La **BingX Card** es una tarjeta de exchange (Visa/Wirex) con cashback en USDT de hasta el 5 %, condicionada a un estatus VIP. La **Nexo Card** se respalda en una línea de crédito garantizada por tus criptos, con un cashback de hasta el 2 % sin staking y un emisor mejor establecido en Europa.",
    es_verdict: "La **Nexo Card** se impone en previsibilidad y disponibilidad (cashback sin condición de volumen, actor más establecido). La **BingX Card** resulta interesante si ya eres usuario VIP de BingX y quieres un cashback en USDT. Para la tranquilidad regulatoria, Nexo mantiene la ventaja.",
    it_intro: "BingX Card e Nexo Card contrappongono due filosofie. La **BingX Card** è una carta di exchange (Visa/Wirex) con cashback in USDT fino al 5 %, condizionata a uno stato VIP. La **Nexo Card** si basa su una linea di credito garantita dalle tue crypto, con un cashback fino al 2 % senza staking e un emittente meglio consolidato in Europa.",
    it_verdict: "La **Nexo Card** prevale su prevedibilità e disponibilità (cashback senza condizione di volume, operatore più consolidato). La **BingX Card** diventa interessante se sei già un utente VIP di BingX e vuoi un cashback in USDT. Per la tranquillità normativa, Nexo mantiene il vantaggio.",
    en_intro: "BingX Card and Nexo Card contrast two philosophies. The **BingX Card** is an exchange card (Visa/Wirex) with cashback in USDT up to 5%, conditional on a VIP status. The **Nexo Card** is backed by a credit line secured by your crypto, with cashback up to 2% without staking and an issuer better established in Europe.",
    en_verdict: "The **Nexo Card** wins on predictability and availability (cashback with no volume condition, a more established player). The **BingX Card** becomes interesting if you're already a VIP BingX user and want cashback in USDT. For regulatory peace of mind, Nexo keeps the edge.",
  ...
  'bingx-metal-card-vs-okx-card': {
    de_intro: "BingX Card und OKX Card sind zwei Visa-Karten großer Börsen, im EWR verfügbar und an Stufen gebunden, die von der Aktivität auf der Plattform abhängen. Die **BingX Card** hebt sich durch ihr Cashback in **USDT** (Stablecoin) ab, während die OKX Card im OKX-Ökosystem angesiedelt ist. Keine von beiden ist MiCA-lizenziert.",
    de_verdict: "Entscheidend ist das Ökosystem: Nehmen Sie die Karte der Börse, die Sie bereits nutzen. Die **BingX Card** bietet den Vorteil eines planbaren Cashbacks in USDT; die **OKX Card** passt zu aktiven OKX-Nutzern. Vergleichen Sie die monatlichen Obergrenzen und Ihre tatsächlichen Volumina, bevor Sie sich entscheiden.",
    es_intro: "BingX Card y OKX Card son dos tarjetas Visa de grandes exchanges, disponibles en el EEE y sujetas a niveles ligados a la actividad en la plataforma. La **BingX Card** destaca por su cashback en **USDT** (stablecoin), mientras que la OKX Card se inscribe en el ecosistema OKX. Ninguna de las dos tiene licencia MiCA.",
    es_verdict: "El factor decisivo es el ecosistema: elige la tarjeta del exchange que ya utilizas. La **BingX Card** tiene la ventaja de un cashback predecible en USDT; la **OKX Card** convendrá a los usuarios activos de OKX. Compara los límites mensuales y tus volúmenes reales antes de elegir.",
    it_intro: "BingX Card e OKX Card sono due carte Visa di grandi exchange, disponibili nel SEE e soggette a livelli legati all'attività sulla piattaforma. La **BingX Card** si distingue per il suo cashback in **USDT** (stablecoin), mentre la OKX Card si inserisce nell'ecosistema OKX. Nessuna delle due è licenziata MiCA.",
    it_verdict: "Il fattore decisivo è l'ecosistema: scegli la carta dell'exchange che già utilizzi. La **BingX Card** ha il vantaggio di un cashback prevedibile in USDT; la **OKX Card** sarà adatta agli utenti attivi di OKX. Confronta i massimali mensili e i tuoi volumi reali prima di scegliere.",
    en_intro: "BingX Card and OKX Card are two Visa cards from major exchanges, available in the EEA and subject to tiers tied to activity on the platform. The **BingX Card** stands out for its cashback in **USDT** (stablecoin), whereas the OKX Card sits within the OKX ecosystem. Neither is MiCA-licensed.",
    en_verdict: "The deciding factor is the ecosystem: take the card of the exchange you already use. The **BingX Card** has the advantage of predictable USDT cashback; the **OKX Card** will suit active OKX users. Compare the monthly caps and your real volumes before choosing.",
