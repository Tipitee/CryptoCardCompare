...
export const CARD_REVIEWS: CardReview[] = [
  ...
  // ─────────────────────────────────────────────── GNOSIS PAY ───
  {
    ...
    keyStats: {
      cashbackMax: '2 % en EURE (stablecoin euro)',
      stakingRequis: 'Aucun',
      fraisAnnuels: '0 €',
      disponibilite: 'UE (France incluse)',
    },
    pros: [
      'Vraie self-custody : vos fonds restent dans votre Safe wallet sur Gnosis Chain',
      '2 % de cashback en EURE (stablecoin indexé sur l\'euro, sans volatilité)',
      'Aucun staking requis, aucun frais annuel',
      'Transparence totale : transactions on-chain vérifiables',
      'Conforme MiCA — infrastructure décentralisée',
      'Cashback en stablecoin : valeur stable, sans risque crypto',
    ],
    cons: [
      'Nécessite de comprendre le fonctionnement d\'un Safe wallet et de Gnosis Chain',
      'Onboarding plus complexe que les cartes custodiales classiques',
      'Cashback limité à 2 % (sans options d\'augmentation)',
      'Communauté et support moins établis que les grands exchanges',
      'Application encore moins mature que Crypto.com ou Binance',
      'Non disponible hors UE pour l\'instant',
    ],
    verdict: 'Gnosis Pay est la seule carte crypto du marché à offrir une vraie expérience non-custodiale : vos fonds restent dans votre propre Safe wallet, sans jamais passer par un intermédiaire centralisé. Le cashback de 2 % en EURE (stablecoin euro) est une proposition unique — vous accumulez de la valeur stable sans risque de dépréciation. Idéale pour les utilisateurs Web3 engagés. Pour les débutants ou ceux qui cherchent la simplicité, une carte custodiale sera plus adaptée.',
    sections: {
      presentation: `**Gnosis Pay** est la première carte de débit crypto véritablement non-custodiale. Elle est émise par Gnosis et s'appuie sur la **Gnosis Chain** (une sidechain EVM compatible Ethereum). La carte est liée à un **Safe wallet** (anciennement Gnosis Safe), le portefeuille multisig le plus sécurisé de l'écosystème Web3, utilisé par des milliers de DAOs et entreprises pour gérer des milliards d'actifs. La carte Visa physique et virtuelle est disponible dans toute l'UE sans frais annuels.`,
      cashback: `Le cashback est de **2 % en EURE**, le stablecoin euro natif de Gnosis Chain (1 EURE = 1 EUR, indexé sur l'euro). C'est une proposition unique dans l'univers des cartes crypto : vous gagnez du cashback en valeur stable, sans exposition à la volatilité des cryptomonnaies. Les 2 % sont appliqués sur toutes vos dépenses, sans plafond et sans condition de staking.`,
      frais: `**0 € de frais annuels.** Les transactions en euros sont gratuites. Les conversions et paiements en devises étrangères peuvent entraîner de légers frais de change. Les retraits DAB sont disponibles selon les conditions Visa standard. Aucun frais de rechargement depuis Gnosis Chain.`,
      securite: `Gnosis Pay offre le plus haut niveau de sécurité des cartes crypto non-custodiales. Vos actifs restent dans votre **Safe wallet** sur la Gnosis Chain — Gnosis n'a à aucun moment accès à vos fonds. En cas de compromission de la plateforme, vos actifs sont protégés. Toutes les transactions sont enregistrées **on-chain** et vérifiables publiquement. La carte supporte la **2FA** et le blocage instantané via l'application.`,
      experience: `L'expérience utilisateur est plus technique que celle des cartes custodiales classiques. L'onboarding nécessite de créer ou connecter un Safe wallet et de comprendre les bases de Gnosis Chain. Une fois configurée, la carte s'utilise comme n'importe quelle Visa. L'application Gnosis Pay permet de suivre les transactions, le cashback en EURE, et l'état du portefeuille. Compatible **Apple Pay** et **Google Pay**. Le support est disponible via Discord et le site officiel.`,
    },
    affiliateLink: 'https://gnosispay.com',
    metaTitle: 'Gnosis Pay Avis 2026 — La Carte Crypto Non-Custodiale avec 2% EURE',
    metaDescription: 'Avis Gnosis Pay 2026 : carte crypto self-custody, 2% cashback en EURE (stablecoin euro), 0 frais annuels, 0 staking. Test complet et verdict pour utilisateurs Web3.',
  },
  ...
  // ─────────────────────────────────────────────── METAMASK CARD ───
  {
    ...
    issuer: 'MetaMask (Consensys / Baanx)',
    network: 'Mastercard',
    updatedAt: '2026-06-16',
    globalRating: 4.0,
    badge: 'Pour les utilisateurs ETH',
    ratingBreakdown: {
      cashback: 3.5,
      frais: 5.0,
      facilite: 4.2,
    ...
    keyStats: {
      cashbackMax: '1 % en ETH',
      stakingRequis: 'Aucun',
      fraisAnnuels: '0 €',
      disponibilite: 'UE (France incluse)',
    },
    pros: [
      'Liée directement à votre wallet MetaMask — pas de KYC Exchange',
      '1 % de cashback en ETH, l\'actif crypto le plus utilisé',
      'Aucun staking requis, aucun frais annuel',
      'Self-custody native : vos fonds restent dans votre wallet MetaMask',
      'Mastercard acceptée partout dans le monde',
      'Idéale pour les détenteurs d\'ETH qui veulent l\'utiliser au quotidien',
    ],
    cons: [
      'Cashback limité à 1 % (moins compétitif que Brighty ou Bybit)',
      'ETH est volatile — la valeur du cashback fluctue',
      'Nécessite un wallet MetaMask et des notions de DeFi',
      'Moins de fonctionnalités premium que les cartes custodiales',
      'Support encore en développement',
      'Disponibilité limitée à l\'UE pour l\'instant',
    ],
    verdict: 'La MetaMask Card est la carte naturelle des utilisateurs de l\'écosystème Ethereum : elle vous permet de dépenser vos cryptos directement depuis votre wallet MetaMask, sans passer par un exchange centralisé. Le cashback de 1 % en ETH est modeste mais cohérent avec le profil self-custody. Si vous utilisez déjà MetaMask au quotidien et souhaitez simplement monetiser vos dépenses en ETH, cette carte est faite pour vous. Pour maximiser le cashback, Brighty ou Nexo offrent de meilleures conditions.',
    sections: {
      presentation: `La **MetaMask Card** est une Mastercard émise par Consensys (la société derrière MetaMask) en partenariat avec Baanx. Elle permet aux 30 millions d'utilisateurs actifs de MetaMask d'utiliser leurs cryptos pour payer dans le monde réel, directement depuis leur wallet MetaMask. C'est l'une des rares cartes du marché à ne pas nécessiter de compte sur un exchange centralisé — votre wallet MetaMask suffit.`,
      cashback: `Le cashback est de **1 % en ETH** sur toutes les dépenses, sans plafond ni condition. L'ETH est crédité directement dans votre wallet MetaMask. C'est un moyen simple d'accumuler de l'Ether passivement via vos achats quotidiens. Le taux de 1 % est inférieur à celui de certains concurrents, mais il est versé dans l'actif le plus liquide de l'écosystème Ethereum.`,
      frais: `**0 € de frais annuels.** Les transactions en euros ne génèrent pas de frais supplémentaires. Les conversions depuis les cryptos du wallet MetaMask s'effectuent au cours du marché. Les retraits DAB sont disponibles selon les conditions Mastercard standard.`,
      securite: `La MetaMask Card hérite du modèle de sécurité de MetaMask : vos fonds sont sous votre contrôle via votre **seed phrase MetaMask**. Seul vous pouvez accéder à votre wallet. Les transactions on-chain sont publiques et vérifiables. La carte elle-même est sécurisée par **Baanx** (fintech régulée en UE) et supporte la **3D Secure**, le **blocage instantané**, et la **2FA**. MetaMask est utilisée par plus de 30 millions d'utilisateurs actifs mensuels.`,
      experience: `Pour commencer, il suffit de connecter votre wallet MetaMask et de compléter la vérification d'identité (KYC obligatoire pour la carte physique). L'application MetaMask intègre la gestion de la carte, le suivi des dépenses et du cashback ETH. La carte est compatible **Apple Pay** et **Google Pay**. Le support est disponible via le Help Center MetaMask et la communauté Discord.`,
    },
    affiliateLink: 'https://metamask.io/card',
    metaTitle: 'MetaMask Card Avis 2026 — Cashback ETH Sans Exchange Centralisé',
    metaDescription: 'Avis MetaMask Card 2026 : carte crypto liée à votre wallet MetaMask, 1% cashback en ETH, 0 frais annuels, 0 staking. Test complet pour utilisateurs Ethereum.',
  },
  ...
  // ─────────────────────────────────────────────── BRIGHTY ───
  {
    ...
    updatedAt: '2026-06-16',
    globalRating: 4.3,
    badge: 'Meilleur cashback sans staking',
    ratingBreakdown: {
      cashback: 5.0,
      frais: 5.0,
      facilite: 4.5,
    ...
    keyStats: {
      cashbackMax: 'Jusqu\'à 4 % en crypto',
      stakingRequis: 'Aucun',
      fraisAnnuels: '0 €',
      disponibilite: 'UE (France incluse)',
    },
    pros: [
      'Jusqu\'à 4 % de cashback — le plus élevé du marché sans staking',
      'Aucun staking requis, aucun frais annuel',
      'Cashback en crypto au choix (BTC, ETH, USDT…)',
      'Application simple et intuitive',
      'Visa acceptée partout dans le monde',
      'Idéale pour maximiser le cashback sans immobiliser du capital',
    ],
    cons: [
      'Brighty est une plateforme custodiale — vos fonds sont chez eux',
      'Moins de notoriété que Crypto.com ou Nexo',
      'Conditions exactes du 4 % à vérifier (paliers de dépenses)',
      'Support encore en développement',
      'Pas disponible hors UE',
      'Token natif moins liquide que BNB ou CRO',
    ],
    verdict: 'Brighty est le meilleur choix si votre priorité est de maximiser le cashback sans bloquer de capital en staking. Avec jusqu\'à 4 % sans aucune condition de staking, elle dépasse toutes les cartes custodiales gratuites du marché sur ce critère. Idéale pour les utilisateurs qui veulent le meilleur rendement sur leurs dépenses quotidiennes. La contrepartie : Brighty est moins connue que les grands exchanges, et la garde de vos fonds est centralisée.',
    sections: {
      presentation: `**Brighty** est une néobanque crypto fondée en Suisse, disponible dans toute l'UE. Son positionnement est simple et efficace : offrir le cashback crypto le plus élevé du marché sans exiger de staking. La carte Visa Brighty est gratuite (0 € de frais annuels) et peut être commandée depuis l'application mobile disponible sur iOS et Android.`,
      cashback: `Le cashback Brighty peut atteindre **4 % en crypto**, ce qui en fait l'offre la plus généreuse du marché parmi les cartes sans staking. Le cashback est versé en cryptomonnaie (BTC, ETH, USDT ou autres selon la sélection disponible dans l'app). Les taux exacts dépendent du palier de dépenses mensuel — plus vous dépensez, plus le taux est élevé. Aucun staking, aucun token natif à immobiliser.`,
      frais: `**0 € de frais annuels.** La carte physique est envoyée gratuitement. Les transactions en euros ne génèrent pas de frais supplémentaires. Les conversions depuis les cryptos du compte Brighty s'effectuent au cours du marché. Les retraits DAB sont disponibles avec des limites mensuelles selon le plan.`,
      securite: `Brighty est une plateforme custodiale régulée en UE (licence suisse). Vos fonds sont stockés chez Brighty — vous n'avez pas la garde directe de vos clés privées. La plateforme utilise la **2FA**, le **chiffrement des données**, et propose le **blocage de carte instantané** via l'app. Les fonds sont protégés par des mesures de sécurité conformes aux standards fintech européens.`,
      experience: `L'application Brighty est notée positivement pour sa simplicité : interface claire, onboarding rapide (KYC en quelques minutes), et gestion intuitive du cashback. La carte est compatible **Apple Pay** et **Google Pay**. La livraison de la carte physique prend quelques jours ouvrables dans l'UE. Le support est disponible via chat in-app et email.`,
    },
    affiliateLink: 'https://brighty.app',
    metaTitle: 'Brighty Card Avis 2026 — Jusqu\'à 4% Cashback Sans Staking',
    metaDescription: 'Avis Brighty Card 2026 : jusqu\'à 4% de cashback en crypto sans staking, 0 frais annuels. La carte crypto avec le meilleur rendement sans condition. Test complet.',
  },
];
