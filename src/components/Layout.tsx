          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400 mb-6">
                ...
                <li>
                  <a href={`/etudes/${({ fr: 'cartes-crypto-2026', be: 'cartes-crypto-2026', de: 'krypto-karten-2026', at: 'krypto-karten-2026', es: 'tarjetas-cripto-2026', it: 'carte-crypto-2026', pt: 'cartoes-crypto-2026', en: 'crypto-cards-2026' } as Record<string, string>)[lang] ?? 'cartes-crypto-2026'}`} className="hover:text-cyan-accent transition-colors flex items-center gap-1.5">
                    <BarChart3 className="w-3.5 h-3.5" />
                    {({ fr: 'Étude cartes crypto 2026', be: 'Étude cartes crypto 2026', de: 'Studie Krypto-Karten 2026', at: 'Studie Krypto-Karten 2026', es: 'Estudio tarjetas cripto 2026', it: 'Studio carte crypto 2026', pt: 'Estudo cartões crypto 2026', en: 'Crypto cards study 2026' } as Record<string, string>)[lang] ?? 'Crypto cards study 2026'}
                  </a>
                </li>
              </ul>
