...
const FR_REVIEWS = [
  {
    ...
    keyStats: { cashbackMax: "Jusqu'à 5 % en USDT (carte Metal)", stakingRequis: 'Aucun token à bloquer (statut VIP requis)', fraisAnnuels: '≈ 12 € / an (1 €/mois)', disponibilite: 'EEE — hors UK, US et Pays-Bas' },
    pros: ["Cashback versé en USDT, un stablecoin (valeur stable, contrairement aux tokens maison)","Jusqu'à 5 % de cashback avec la carte Metal (palier VIP 3)","Propulsée par Wirex, une infrastructure de paiement éprouvée","Retraits DAB gratuits jusqu'à 200 $/mois","Carte virtuelle disponible instantanément, compatible Apple Pay et Google Pay","Limites de dépense élevées"],
    cons: ["Meilleurs taux réservés aux paliers VIP (volume de trading sur BingX)","Frais de tenue de 1 €/mois (≈ 12 €/an)","Cashback plafonné : 50 $/mois (virtuelle), 120 $/mois (Metal)","BingX non licencié MiCA, réglementation offshore","Indisponible au Royaume-Uni, aux États-Unis et aux Pays-Bas","Fonds conservés sur l'exchange (pas de self-custody)"],
